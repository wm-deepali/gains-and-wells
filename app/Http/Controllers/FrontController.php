...
class FrontController extends Controller
{
    ...
    public function blogDetails($slug)
    {
        ...
        return view('front.blog-details', compact('blog', 'categories', 'trendingPosts'));
    }

    public function blogCategory($slug)
    {
        $category = BlogCategory::where('url', $slug)->where('status', 'active')->first();
        ...
        $categories = BlogCategory::whereNot('id', $category->id)->where('status', 'active')->get();
        ...
        return view('front.blog-category', compact('category', 'blogs', 'categories', 'trendingPosts'));
