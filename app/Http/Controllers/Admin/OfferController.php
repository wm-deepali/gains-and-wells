  ...
  public function update(Request $request, $id)
{
    ...
    public function offerdeatilsdelete($id)
    {
        try {
            $state = OfferEnquiry::findOrFail($id);
            $state->delete();
            return response()->json([
                'success' => true,
            ]);
    ...
    public function offerdeatils()
    {
       $offerdeatils = OfferEnquiry::with('offer')->latest()->get();
        return view('admin.offerdeatils.index')->with([
