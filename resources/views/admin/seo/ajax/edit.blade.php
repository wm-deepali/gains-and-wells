    ...
    <form class="form form-horizontal">
        ...
        <div class="modal-content">
                ...
                <div class="row border m-1 p-2 bg-light">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <select class="form-control" name="page_slug" id="page_slug" required>
                            ...
                            <option value="{{ $page->slug }}" @if ($page->slug == $seo->page_slug) selected @endif>{{ $page->title }}</option>
                            @endforeach
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Meta Title" name="meta_title" id="meta_title" maxlength="70" value="{{$seo->meta_title ?? null }}">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Keywords" name="meta_keyword" id="meta_keyword">{{$seo->meta_keyword ?? null }}</textarea>
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Description" name="meta_description" id="meta_description" maxlength="170">{{$seo->meta_description ?? null }}</textarea>
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter  OG Tags & Scripts" name="scripts_text" id="scripts_text">{{$seo->scripts_text ?? null }}</textarea>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="update-seo-btn" seo_id="{{ $seo->id }}">Submit</button>
