                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        ...
                        <input type="number" step="0.01" class="form-control" name="mrp" id="mrp"
                               value="{{ old('mrp', $package->mrp ?? '') }}" required>
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        ...
                        <input type="number" step="0.01" class="form-control" name="discount" id="discount"
                               value="{{ old('discount', $package->discount ?? '') }}" required>
                    </div>
                </div>
...
{{-- Script --}}
<script>
    // Function to calculate the offered price
    ...
    if (mrpInput && discountInput) {
        ...
        calculateOfferPrice(); // Initial calculation
    }
