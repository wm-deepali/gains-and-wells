            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($blog->image!=null)
                        <div class="m-2"><img src="{{ asset('storage/blogs/'.$blog->image) }}"height="50"> </div>
                        @endif
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Image Alt Tag" name="image_alt" id="image_alt" value="{{ $blog->image_alt }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" name="short_description" id="short_description" cols="30" rows="2" maxlength="170">{{ $blog->short_description }}</textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="date" class="form-control" placeholder="Enter Publish Date" name="publish_date" id="publish_date" value="{{ $blog->publish_date }}">
                ...
                <div class="row border m-1 p-2 bg-light">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Meta Title" name="meta_title" id="meta_title" maxlength="70" value="{{$blog->meta_title ?? null }}">
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Keywords" name="meta_keyword" id="meta_keyword">{{$blog->meta_keyword ?? null }}</textarea>
                    ...
                    <div class="col-md-12 form-group">
                        ...
                        <textarea class="form-control" rows="4" cols="7" placeholder="Enter Meta Description" name="meta_description" id="meta_description" maxlength="170">{{$blog->meta_description ?? null }}</textarea>
