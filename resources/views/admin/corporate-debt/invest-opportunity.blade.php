        ...
        <div class="breadcrumbs-top d-flex align-items-center bg-light mb-3">
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb bg-transparent mb-0">
                    ...
                    <li class="breadcrumb-item active">Manage Invest Opportunity</li>
                </ol>
            </div>
...
$.ajax({
url: `{{ URL::to('admin/manage-corporate-debt/invest-opportunity/delete-invest/${id}') }}`,
type: "POST",
dataType: "json",
...
$.ajax({
url: "{{ URL::to('admin/manage-corporate-debt/invest-opportunity/create') }}",
type: "GET",
dataType: "json",
success: function(result) {
if (result.success) {
...
$.ajax({
url: "{{ URL::to('admin/manage-join-category') }}",
type: 'POST',
processData: false,
contentType: false,
dataType: 'json',
...
$.ajax({
url: `{{ URL::to('admin/manage-corporate-debt/invest-opportunity/edit-invest/${id}') }}`,
type: "get",
dataType: "json",
success: function(result) {
if (result.success) {
