        ...
        <div class="breadcrumbs-top d-flex align-items-center bg-light mb-3">
            <div class="breadcrumb-wrapper">
                <ol class="breadcrumb bg-transparent mb-0">
                    ...
                    <li class="breadcrumb-item active">Manage Get In Early</li>
                </ol>
            </div>
...
$.ajax({
url: `{{ URL::to('admin/manage-get-early/delete-early/${id}') }}`,
type: "POST",
dataType: "json",
...
$.ajax({
url: "{{ URL::to('admin/manage-get-early/create-early') }}",
type: "GET",
dataType: "json",
success: function(result) {
if (result.success) {
...
$.ajax({
url: `{{ URL::to('admin/manage-get-early/edit-early/${id}') }}`,
type: "get",
dataType: "json",
success: function(result) {
if (result.success) {
