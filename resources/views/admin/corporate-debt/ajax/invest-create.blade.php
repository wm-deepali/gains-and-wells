<div class="modal-dialog modal-lg">
    <!-- Modal content-->
    <form method="post" action="{{ route('admin.manage-corporate-debt.invest-opportunity.invest-opportunity-store') }}" enctype="multipart/form-data">
        @csrf
        
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Invest Opportunity</h4>
