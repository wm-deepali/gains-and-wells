<div class="modal-dialog modal-lg">
    <!-- Modal content-->
    <form method="post" action="{{ route('admin.manage-past-opportunity.update-opportunity') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" value="{{ $blog->id}}" name="id">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Edit Past Opportunity</h4>
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($blog->image!=null)
                        <div class="m-2"><img src="{{ asset('storage/startup/'.$blog->image) }}"height="50"> </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-12">
                        ...
                        <input type="text" class="form-control" value="{{ $blog->heading}}" placeholder="Enter Heading" name="heading" id="heading">
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                        ...
                        <input type="text" class="form-control" value="{{ $blog->percentage}}" placeholder="Enter Percentage" name="percentage" id="percentage">
                        <div class="text-danger" id="percentage-err"></div>
                    </div>
                    
                    <div class="col-md-6">
                        <label class="label-control label">Months <span class="required">*</span></label>
                        <input type="text" class="form-control" value="{{ $blog->months}}" placeholder="Enter Months" name="months" id="months">
