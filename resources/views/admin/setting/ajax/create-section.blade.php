<div class="modal-dialog">
    ...
    <div class="modal-content">
        <form class="form form-horizontal" method="POST" action="{{ route('admin.manage-sections.store') }}" enctype="multipart/form-data">
            @csrf
                ...
                <div class="form-group row">
                    <div class="col-sm-12" style="margin-top: 12px;display:none;" id="pageval">
                        ...
                        <select class="form-control" name="faq_id" id="faq_id">
                            ...
                            <option value="{{ $faq->page->id }}" >{{ $faq->page->title }}</option>
                            @endif
                            @endforeach
                            @endif
                        </select>
