...
<!-- Mirrored from www.indonez.com/html-demo/wave/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Aug 2025 04:31:28 GMT -->
<!-- Added by HTTrack -->
            ...
            <div class="uk-container uk-container-expand">
                <div class="uk-grid" data-uk-height-viewport="expand: true">
                    <div class="uk-width-3-5@m uk-background-cover uk-background-center-right uk-visible@m uk-box-shadow-xlarge"
                        style="background-image: url({{ asset('front_assets') }}/img/in-signin-image.html);">
                            ...
                            <div class="uk-width-3-5@m">
                                <div class="uk-text-center in-padding-horizontal@s">
                                    <a class="uk-logo" href="index-2.html">
                                        <img src="{{ asset('front_assets') }}/img/in-lazy.gif" data-src="{{ asset('front_assets') }}/img/user/header-logo-EelGlt.svg" alt="logo"
                                            width="134" height="23" data-uk-img>
                                    </a>
                                    <p class="uk-text-lead uk-margin-small-top uk-margin-medium-bottom">Log into your
                                        account</p>
                                    <!-- login form begin -->
                                    <form class="uk-grid uk-form">
                                        <div class="uk-margin-small uk-width-1-1 uk-inline">
                                            <span class="uk-form-icon uk-form-icon-flip fas fa-user fa-sm"></span>
                                            <input class="uk-input uk-border-rounded" id="username" value="" type="text"
                                    ...
                                    <span class="uk-text-small">Don't have an account? <a href="#">Register
                                            here</a></span>
                                </div>
                            </div>
                        </div>
...
<!-- Mirrored from www.indonez.com/html-demo/wave/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 Aug 2025 04:31:29 GMT -->
