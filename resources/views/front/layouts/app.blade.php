...
<head>
  ...
  <!-- preload assets -->
  <link rel="preload" href="{{ asset('front_assets') }}/fonts/fa-brands-400.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="preload" href="{{ asset('front_assets') }}/fonts/fa-solid-900.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="preload" href="{{ asset('front_assets') }}/fonts/rubik-v9-latin-regular.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="preload" href="{{ asset('front_assets') }}/fonts/rubik-v9-latin-500.woff2" as="font" type="font/woff2" crossorigin>
  <link rel="preload" href="{{ asset('front_assets') }}/fonts/rubik-v9-latin-300.woff2" as="font" type="font/woff2" crossorigin>
          ...
          <div class="uk-navbar-left uk-width-expand uk-flex uk-flex-between">
            ...
            <ul class="uk-navbar-nav uk-visible@m">
              ...
              <li><a href="#">About Us<span data-uk-navbar-parent-icon></span></a>
                ...
                <li><a href="#">Investment<span data-uk-navbar-parent-icon></span></a>
                <div class="uk-navbar-dropdown">
                  <ul class="uk-nav uk-navbar-dropdown-nav">
                    <li><a href="#">Our Proposals & Startups</a></li>
                    <li><a href="#">Our Investors</a></li>
                    
                  </ul>
                </div>
              </li>
               <li><a href="#">Real Estate<span data-uk-navbar-parent-icon></span></a>
                <div class="uk-navbar-dropdown">
                  <ul class="uk-nav uk-navbar-dropdown-nav">
                    <li><a href="#">Leasehold Investment</a></li>
                    <li><a href="#">Freehold Investment</a></li>
                    <li><a href="">Co-Ownership</a></li>
        ...
        <div class="uk-grid-medium" data-uk-grid="">
          <div class="uk-width-expand@m">
            <div class="footer-logo">
              <img class="uk-display-block" src="{{ asset('front_assets') }}/img/gainsandwells-logo1.png" alt="footer-logo" width="134" height="23"
                data-uk-img="">
            </div>
                ...
                <div
                  ...
                  <div>
                    <div class="uk-card uk-card-default uk-card-small uk-card-body">
                      <img src="{{ asset('front_assets') }}/img/in-lazy.gif" data-src="{{ asset('front_assets') }}/img/in-wave-visa.svg" alt="wave-payment" width="59"
                        height="22" data-uk-img="">
                    </div>
                  </div>
                  <div>
                    <div class="uk-card uk-card-default uk-card-small uk-card-body">
                      <img src="{{ asset('front_assets') }}/img/in-lazy.gif" data-src="{{ asset('front_assets') }}/img/in-wave-mastercard.svg" alt="wave-payment" width="59"
                        height="22" data-uk-img="">
                    </div>
                  </div>
                  <div>
                    <div class="uk-card uk-card-default uk-card-small uk-card-body">
                      <img src="{{ asset('front_assets') }}/img/in-lazy.gif" data-src="{{ asset('front_assets') }}/img/in-wave-skrill.svg" alt="wave-payment" width="59"
                        height="22" data-uk-img="">
                    </div>
                  </div>
                  <div>
                    <div class="uk-card uk-card-default uk-card-small uk-card-body">
                      <img src="{{ asset('front_assets') }}/img/in-lazy.gif" data-src="{{ asset('front_assets') }}/img/in-wave-paypal.svg" alt="wave-payment" width="59"
                        height="22" data-uk-img="">
                    </div>
                  </div>
                  <div>
                    <div class="uk-card uk-card-default uk-card-small uk-card-body uk-visible@m">
                      <img src="{{ asset('front_assets') }}/img/in-lazy.gif" data-src="{{ asset('front_assets') }}/img/in-wave-neteller.svg" alt="wave-payment" width="59"
                        height="22" data-uk-img="">
                    </div>
                  </div>
                </div>
