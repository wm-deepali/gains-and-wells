                ...
                <div class="row g-0" style="margin: auto;">
                    <div class="col-lg-6">
                        <div class="col-bg-img-thirty-seven prt-bg prt-col-bgimage-yes col-bg-img-six">
                            ...
                            <div class="layer-content form-banner-content">
                                <h1 style="color:#fff; font-size:28px;font-weight:600;">Get a Free Consultation – Start Your Business Journey Today!</h1>
                                <p style="color:#fff; font-size:16px;">Fill out the form below and our experts will guide you through the easy & simple process to reach your financial or a business goal, Quick response, expert advice, no obligations.</p>
                            </div>
                        </div>
                        <!--<img class="" src="{{asset('assets/images/bg-image/col-bgimage-37.png')}}"-->
                    ...
                    <div class="col-lg-6">
                        <div class="bg-base-grey spacing-25">
                            ...
                            <form action="{{ route('submit.package') }}" class="contact_form clearfix" method="post" id="callfrm">
                                 @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <button type="button" class="btn btn-primary mb-2" id="send-otp-bt"  style="display: none;">Send OTP</button>
                                        <button type="button" class="btn btn-primary mb-2" id="verify-otp-bt" style="display: none;" >Verify</button>
                                        <button type="button" class="btn btn-primary mb-2" id="resend-otp-bt"  style="display: none;">Resend OTP</button>
                                    </div>
                        <div class="col-md-12">
        ...
        <div class="g-recaptcha mt-4" data-sitekey={{config('services.recaptcha.key')}}></div>
                                    ...
                                    <div class="mt-5">
                                        <button
                                            ...
                                            type="submit" value="submit" disabled>Submit Here</button>
                                    </div>
                                </div>
                            </form>
                        </div>
