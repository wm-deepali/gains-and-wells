	...
	<main>
		...
		<div class="uk-section in-wave-12 in-offset-bottom-60">
			<div class="uk-container">
				...
				<div class="uk-grid uk-flex uk-flex-center uk-background-contain uk-background-top-center in-testimoni-wrap" style="background-image: url({{ asset('front_assets') }}/img/in-wave-testibg.jpg);">
					<div class="uk-width-3-4@m">
						<div class="uk-flex uk-flex-middle" data-uk-grid>
							<div class="uk-width-1-1 uk-width-auto@m uk-flex-last uk-flex-first@m">
								<img class="uk-align-center uk-margin-remove-bottom" src="{{ asset('front_assets') }}/img/blockit/in-testimoni-1.png" alt="client-testimoni" width="300" height="317">
							</div>
			...
			<div class="uk-container">
				<div class="uk-grid-large uk-position-relative" data-uk-grid>
					<div class="uk-position-bottom-right in-wave-mockup">
						<img src="{{ asset('front_assets') }}/img/in-wave-mockup-3.png" alt="wave-mockup" width="860" height="530">
					</div>
					<div class="uk-width-1-2@m">
						...
						<div class="uk-child-width-1-3@m uk-margin-large-top" data-uk-grid>
							<div>
								<img class="uk-margin-remove-bottom" src="{{ asset('front_assets') }}/img/in-wave-icon-11.svg" alt="wave-icon" width="42" height="42">
								<h4 class="uk-margin-top">Daily analysis</h4>
								<p>Ducimus temporibus vel assumenda ad fugit culpa vero.</p>
							</div>
							<div>
								<img class="uk-margin-remove-bottom" src="{{ asset('front_assets') }}/img/in-wave-icon-12.svg" alt="wave-icon" width="42" height="42">
								<h4 class="uk-margin-top">$100 deposit</h4>
								<p>Vel assumenda ad fugit culpa provident quaemol alias.</p>
							</div>
							<div>
								<img class="uk-margin-remove-bottom" src="{{ asset('front_assets') }}/img/in-wave-icon-13.svg" alt="wave-icon" width="42" height="42">
		...
		<!-- section content end -->
		<!-- section content begin -->
		<div class="uk-section uk-section-default uk-background-contain uk-background-center-right in-wave-15 in-offset-bottom-30" style="background-image: url({{ asset('front_assets') }}/img/in-wave-background-3.png);">
			<div class="uk-container">
				<div class="uk-grid uk-flex uk-flex-middle">
					...
					<div class="uk-width-1-2@s uk-width-expand@m uk-flex uk-flex-center in-margin-medium-top@s">
						<img src="{{ asset('front_assets') }}/img/in-wave-mockup-4.html" alt="wave-mockup" width="292" height="286">
					</div>
