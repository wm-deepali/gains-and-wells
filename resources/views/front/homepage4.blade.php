...
@section('content')
	...
	<main>
						...
						<div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded in-margin-medium-top@s">
							<div class="uk-grid" data-uk-grid>
								<div class="uk-width-expand@s uk-width-2-5@m uk-card-media-right uk-cover-container">
									<img class="uk-width-1-1 uk-margin-remove-bottom" src="{{ asset('front_assets') }}/img/in-wave-image-2.html" alt="sample-image" width="564" height="625">
								</div>
								<div class="uk-width-1-2@s uk-width-expand@m uk-flex uk-flex-middle">
									<div class="uk-card-body">
										...
										<div class="uk-child-width-1-3@m uk-text-center uk-visible@m" data-uk-grid>
											<div>
												<img src="{{ asset('front_assets') }}/img/in-wave-award.html" alt="wave-award" width="71" height="58">
							...
							<div class="uk-width-expand@m">
								<div class="uk-grid-medium uk-child-width-1-4@s uk-child-width-1-5@m uk-text-center in-client-logo-3" data-uk-grid>
									<div class="uk-tile uk-tile-default">
										<img class="uk-margin-remove" src="{{ asset('front_assets') }}/img/in-wave-media-1.html" alt="client-logo" width="147" height="42">
									</div>
									<div class="uk-tile uk-tile-default">
										<img class="uk-margin-remove" src="{{ asset('front_assets') }}/img/in-wave-media-2.html" alt="client-logo" width="147" height="42">
									</div>
									<div class="uk-tile uk-tile-default">
										<img class="uk-margin-remove" src="{{ asset('front_assets') }}/img/in-wave-media-3.html" alt="client-logo" width="147" height="42">
									</div>
									<div class="uk-tile uk-tile-default">
										<img class="uk-margin-remove" src="{{ asset('front_assets') }}/img/in-wave-media-4.html" alt="client-logo" width="147" height="42">
									</div>
									<div class="uk-tile uk-tile-default uk-visible@m">
										<img class="uk-margin-remove" src="{{ asset('front_assets') }}/img/in-wave-media-5.html" alt="client-logo" width="147" height="42">
									</div>
								</div>
							</div>
						</div>
				...
				<div class="uk-grid" data-uk-grid>
					...
					<div class="uk-width-expand@m">
						<div class="uk-grid uk-grid-collapse uk-child-width-1-3@m uk-child-width-1-2@s uk-text-center">
							<div class="uk-tile uk-tile-default">
								<img class="uk-margin-remove-bottom" src="{{ asset('front_assets') }}/img/in-wave-icon-14.html" alt="wave-icon" width="64" height="64">
								<h5 class="uk-margin-small-top">Maximum value</h5>
							</div>
							<div class="uk-tile uk-tile-default">
								<img class="uk-margin-remove-bottom" src="{{ asset('front_assets') }}/img/in-wave-icon-15.html" alt="wave-icon" width="64" height="64">
								<h5 class="uk-margin-small-top">Fast executions</h5>
							</div>
							<div class="uk-tile uk-tile-default">
								<img class="uk-margin-remove-bottom" src="{{ asset('front_assets') }}/img/in-wave-icon-16.html" alt="wave-icon" width="64" height="64">
								<h5 class="uk-margin-small-top">Trading tools</h5>
							</div>
							<div class="uk-tile uk-tile-default">
								<img class="uk-margin-remove-bottom" src="{{ asset('front_assets') }}/img/in-wave-icon-17.html" alt="wave-icon" width="64" height="64">
		...
		<!-- section content end -->
		<!-- section content begin -->
		<div class="uk-section uk-section-muted uk-padding-remove-vertical uk-background-contain uk-background-center-right in-wave-18" style="background-image: url({{ asset('front_assets') }}/img/in-wave-platformbg.html);">
			<div class="uk-container">
				<div class="uk-grid-large uk-flex uk-flex-middle" data-uk-grid>
					...
					<div class="uk-width-1-2@m">
						<img class="uk-align-center uk-align-left@m" src="{{ asset('front_assets') }}/img/in-wave-mockup-5.html" alt="wave-mockup" width="533" height="330">
					</div>
				</div>
			</div>
		</div>
