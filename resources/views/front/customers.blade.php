				...
				<div class="uk-grid uk-child-width-1-2@m in-testimonial-8" data-uk-grid>
					<div>
						<div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
							<img class="uk-position-bottom-right" src="{{ asset('front_assets') }}/img/blockit/in-testimoni-2.html" alt="client-testimoni" width="200">
							...
							<div class="uk-card-footer">
								<img src="{{ asset('front_assets') }}/img/blockit/in-client-testi-1.html" alt="client-logo" width="54">
								<blockquote>
					...
					<div>
						<div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
							<img class="uk-position-bottom-right" src="{{ asset('front_assets') }}/img/blockit/in-testimoni-3.html" alt="client-testimoni" width="200">
							<div class="uk-card-header">
								<blockquote>
							...
							<div class="uk-card-footer">
								<img src="{{ asset('front_assets') }}/img/blockit/in-client-testi-2.html" alt="client-logo" width="54">
								<blockquote>
			...
			<div class="uk-container">
				<div class="uk-grid uk-child-width-1-3@m in-testimonial-7" data-uk-grid>
					<div>
						<div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
							<div class="uk-card-header">
								<img src="{{ asset('front_assets') }}/img/blockit/in-client-testi-3.html" alt="client-logo" width="60">
							</div>
					...
					<div>
						<div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
							<div class="uk-card-header">
								<img src="{{ asset('front_assets') }}/img/blockit/in-client-testi-4.html" alt="client-logo" width="60">
							</div>
							<div class="uk-card-body">
								<blockquote>
					...
					<div>
						<div class="uk-card uk-card-default uk-box-shadow-small uk-border-rounded">
							<div class="uk-card-header">
								<img src="{{ asset('front_assets') }}/img/blockit/in-client-testi-5.html" alt="client-logo" width="60">
							</div>
							<div class="uk-card-body">
								<blockquote>
