...
<div class="top-banner-bank-website-offer">
    ...
    <h1 class="banner-title-top-wesite">Open Your Business Bank Account Easily &  
        <br><span>Expand Your Global Reach Today!</span>
    </h1>
    <div class="position-relative mb-15" style="width: 100%;color: gray;">
        <p style="width: 100%;color: gray;">
            Simplify your bank account opening process with expert assistance for UAE, UK, USA, Canada, and Singapore. 
            Get quick, hassle-free access to business banking solutions and start operating internationally with confidence.
        </p>
    </div>
    
    <button class="cost-calculate-banner1" data-bs-toggle="offcanvas" href="#offcanvasExample">Book Your Free Consultation</button>
</div>
            ...
            <div class="mb-lg-3 mb-3 d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="p-0">Open a Company Bank Account Abroad</p>
                    <h2>Get a Quote</h2>
                </div>
            </div>
   ...
   <div class="col-md-12" style="display:flex;gap:15px;">
    ...
    <div class="title-header">
        <h2 class="title text-center">Expert <span>Bank Account Opening Assistance</span><br>for UAE, UK, USA, Canada & Singapore</h2>
    </div>
    <div class="title-desc text-center">
        <p>
            Opening a business bank account abroad can be complex and time-consuming — but it doesn’t have to be. 
            We specialize in providing fast, reliable, and hassle-free bank account opening services across top global markets like UAE, UK, USA, Canada, and Singapore. 
            Whether you’re a startup, investor, or business owner, our experienced team guides you step-by-step through the entire process, ensuring all compliance and documentation are handled smoothly. 
            Partner with us to secure your banking solution effortlessly and unlock seamless financial access for your international business.
        </p>
    </div>
</div>
<!-- section title end -->
                ...
                <div class="row col-10">
                        ...
                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3 style="color: #fff;">Expert Documentation Guidance
                                    </h3>
                                </div>
                                <div class="featured-desc">
                                    <p>We assist in preparing and organizing all the required documents accurately to meet banking standards in each country.
                    ...
                    <div class="col-md-6 residency-key-points">
                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3 style="color: #fff;">Direct Bank Liaison & Follow-Up</h3>
                                </div>
                                <div class="featured-desc">
                                    <p >Our team communicates directly with banks to expedite your application and keep you updated at every step. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 ">
                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3 style="color: #fff;">Multi-Country Expertise</h3>
                                </div>
                                <div class="featured-desc">
                                    <p >We provide specialized assistance for bank account opening in UAE, UK, USA, Canada, and Singapore to match each country’s unique banking requirements.
                    ...
                    <div class="col-md-6 ">
                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3 style="color: #fff;">Post-Account Opening Support</h3>
                                </div>
                                <div class="featured-desc">
                                    <p > After your account is active, we assist with activation, banking tools, and ongoing support for your business needs.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Visa Cards Starts -->
             ...
             <div class="service-page-service-card  mb-25 mt-30" >
            
          <ul class="country-tab-menu" role="tablist">
    <li class="active" data-bs-toggle="tab" data-bs-target="#uae">
        <img src="<?php echo e(asset('assets/images/uae-flag.png')); ?>" alt="UAE Flag"> UAE
    </li>
    <li data-bs-toggle="tab" data-bs-target="#usa">
        <img src="<?php echo e(asset('assets/images/usa-flag.png')); ?>" alt="USA Flag"> USA
    </li>
    <li data-bs-toggle="tab" data-bs-target="#uk">
        <img src="<?php echo e(asset('assets/images/uk-flag.png')); ?>" alt="UK Flag"> UK
    </li>
    <li data-bs-toggle="tab" data-bs-target="#canada">
        <img src="<?php echo e(asset('assets/images/canada-flag.png')); ?>" alt="Canada Flag"> Canada
    </li>
    <li data-bs-toggle="tab" data-bs-target="#singapore">
        <img src="<?php echo e(asset('assets/images/singapore.png')); ?>" alt="Singapore Flag"> Singapore
    </li>
</ul>

<div class="tab-content mt-4">
    <div class="tab-pane fade show active" id="uae">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        ...
                        <tr><td>4</td><td>Proof of UAE Residential Address (Utility Bill, Tenancy Contract, or Ejari Certificate)</td></tr>
                        <tr><td>5</td><td>Bank Reference Letter from Existing Bank (Optional but recommended)</td></tr>
                        <tr><td>6</td><td>Emirates ID Copy (if available)</td></tr>
                        <tr><td>7</td><td>Personal Bank Statements (Last 6 months)</td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Trade License Copy (Valid and current)</td></tr>
                        <tr><td>2</td><td>Memorandum of Association (MOA) / Local Service Agent Agreement</td></tr>
                        <tr><td>3</td><td>Shareholder / Partner Passport Copies</td></tr>
                        <tr><td>4</td><td>Board Resolution Authorizing Bank Account Opening (If applicable)</td></tr>
                        <tr><td>5</td><td>Company’s Certificate of Incorporation</td></tr>
                        <tr><td>6</td><td>Tenancy Contract / Ejari Certificate</td></tr>
                        <tr><td>7</td><td>Completed Bank Application Form</td></tr>
                        <tr><td>8</td><td>Proof of Business Address</td></tr>
                        <tr><td>9</td><td>Financial Statements (Last 1-2 years) or Business Plan (For startups)</td></tr>
                        <tr><td>10</td><td>Reference Letter from Existing Bank (if available)</td></tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Valid Passport Copy</td></tr>
                        <tr><td>2</td><td>Valid U.S. Visa or ESTA (if applicable)</td></tr>
                        <tr><td>3</td><td>Social Security Number (SSN) or Individual Taxpayer Identification Number (ITIN)</td></tr>
                        <tr><td>4</td><td>Proof of U.S. Residential Address (Utility Bill, Lease Agreement, or Bank Statement)</td></tr>
                        <tr><td>5</td><td>Recent Passport Size Photograph (if required)</td></tr>
                        <tr><td>6</td><td>Bank Reference Letter (optional but recommended)</td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Certificate of Formation or Incorporation</td></tr>
                        <tr><td>2</td><td>Employer Identification Number (EIN)</td></tr>
                        <tr><td>3</td><td>Operating Agreement (for LLC) or Bylaws (for Corporations)</td></tr>
                        <tr><td>4</td><td>Valid Passport Copies of Owners / Partners</td></tr>
                        <tr><td>5</td><td>Proof of U.S. Business Address (Lease Agreement, Utility Bill, etc.)</td></tr>
                        <tr><td>6</td><td>Bank Application Form (Completed and Signed)</td></tr>
                        <tr><td>7</td><td>Resolution of Authority / Board Resolution authorizing account opening (if applicable)</td></tr>
                        <tr><td>8</td><td>Financial Statements or Business Plan (especially for startups)</td></tr>
                        <tr><td>9</td><td>Bank Reference Letter (if available)</td></tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Valid Passport Copy</td></tr>
                        <tr><td>2</td><td>Valid UK Visa or Residence Permit (if applicable)</td></tr>
                        <tr><td>3</td><td>Proof of UK Residential Address (Utility Bill, Bank Statement, or Tenancy Agreement - dated within last 3 months)</td></tr>
                        <tr><td>4</td><td>Recent Passport Size Photograph (if requested by bank)</td></tr>
                        <tr><td>5</td><td>National Insurance Number (if available)</td></tr>
                        <tr><td>6</td><td>Bank Reference Letter (optional but recommended)</td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Certificate of Incorporation from Companies House</td></tr>
                        <tr><td>2</td><td>Memorandum and Articles of Association</td></tr>
                        <tr><td>3</td><td>Proof of Registered Office Address in the UK</td></tr>
                        <tr><td>4</td><td>Shareholder and Director Passport Copies</td></tr>
                        <tr><td>5</td><td>Proof of Residential Address for All Directors and Shareholders</td></tr>
                        <tr><td>6</td><td>Business Bank Account Application Form (Completed and Signed)</td></tr>
                        <tr><td>7</td><td>Board Resolution Authorizing Account Opening (if applicable)</td></tr>
                        <tr><td>8</td><td>Business Plan or Financial Statements (especially for startups)</td></tr>
                        <tr><td>9</td><td>VAT Registration Certificate (if applicable)</td></tr>
                        <tr><td>10</td><td>Reference Letter from Previous Bank (if available)</td></tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Valid Passport Copy</td></tr>
                        <tr><td>2</td><td>Canadian Visa or Immigration Document (if applicable)</td></tr>
                        <tr><td>3</td><td>Social Insurance Number (SIN) or Temporary Tax Number</td></tr>
                        <tr><td>4</td><td>Proof of Canadian Residential Address (Utility Bill, Lease Agreement, or Bank Statement)</td></tr>
                        <tr><td>5</td><td>Recent Passport Size Photograph (if requested)</td></tr>
                        <tr><td>6</td><td>Bank Reference Letter (optional but recommended)</td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Certificate of Incorporation / Business Registration</td></tr>
                        <tr><td>2</td><td>Articles of Incorporation or Partnership Agreement</td></tr>
                        <tr><td>3</td><td>Business Number (BN) from Canada Revenue Agency</td></tr>
                        <tr><td>4</td><td>Shareholder / Partner Passport Copies</td></tr>
                        <tr><td>5</td><td>Proof of Business Address in Canada</td></tr>
                        <tr><td>6</td><td>Completed Bank Account Application Form</td></tr>
                        <tr><td>7</td><td>Board Resolution or Authorization Letter (if applicable)</td></tr>
                        <tr><td>8</td><td>Financial Statements or Business Plan (for startups)</td></tr>
                        <tr><td>9</td><td>Bank Reference Letter (if available)</td></tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Valid Passport Copy</td></tr>
                        <tr><td>2</td><td>Singapore Employment Pass, S Pass, or Student Pass (if applicable)</td></tr>
                        <tr><td>3</td><td>Proof of Singapore Residential Address (Utility Bill, Tenancy Agreement, or Bank Statement)</td></tr>
                        <tr><td>4</td><td>Recent Passport Size Photograph (if requested)</td></tr>
                        <tr><td>5</td><td>Bank Reference Letter (optional but recommended)</td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="col-lg-6">
                ...
                <table class="document-table">
                    ...
                    <tbody>
                        <tr><td>1</td><td>Certificate of Incorporation issued by ACRA</td></tr>
                        <tr><td>2</td><td>Company’s Constitution (formerly known as MOA & AOA)</td></tr>
                        <tr><td>3</td><td>Identification documents of Directors and Shareholders (Passport Copies)</td></tr>
                        <tr><td>4</td><td>Proof of Registered Address in Singapore</td></tr>
                        <tr><td>5</td><td>Board Resolution approving the opening of the bank account</td></tr>
                        <tr><td>6</td><td>Completed Bank Account Opening Application Form</td></tr>
                        <tr><td>7</td><td>Business Profile Report from ACRA (dated within last 3 months)</td></tr>
                        <tr><td>8</td><td>Business Plan or Financial Statements (especially for startups)</td></tr>
                        <tr><td>9</td><td>Reference Letter from existing bank (if available)</td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div class="prt-service-single-content-area " style="padding:0px 40px 80px 40px;">
                      ...
                      <div class="featured-content">
    <div class="featured-title">
        <h3>Open Your International Bank Account with Ease</h3>
    </div>
    <div class="featured-desc">
        <p>Receive professional guidance and support to open bank accounts in UAE, USA, UK, Canada, and Singapore.  
        We simplify the process, help with documentation, and ensure quick approval — so you can manage your business finances globally without hassle.</p>
    </div>
    <button class="cost-calculate-banner1 mt-25">Get Free Consultation</button>
</div>
        ...
        <div class="wptb-heading">
            <div class="wptb-item--inner text-center mb-5">
                ...
                <h1 class="wptb-item--title">
                    <span>Trusted Bank Account Opening Assistance </br> in UAE, UK, USA, Canada & Singapore</span>
                </h1>
            </div>
        </div>
                    ...
                    <div class="wptb-item--inner">
                        <div class="wptb-heading">
                            <div class="wptb-item--inner text-center">
                                <h6 class="wptb-item--subtitle">BANKING EXPERTISE ACROSS MARKETS</h6>
                                <h1 class="wptb-item--title" style="font-family: 'fontello';">
                                    <span>Seamless Account Setup with Trusted Support</span>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="wptb-item--images">
                            ...
                            <div class="wptb-avatar avatar-group">
                                <span class="avatar rounded-circle">
                                    <img class="avatar-img rounded-circle" src="<?php echo e(asset('assets/images/1.jpg')); ?>" alt="Client Avatar">
                                </span>
                                <span class="avatar rounded-circle">
                                    <img class="avatar-img rounded-circle" src="<?php echo e(asset('assets/images/2.jpg')); ?>" alt="Client Avatar">
                                </span>
                                <span class="avatar rounded-circle">
                                    <img class="avatar-img rounded-circle" src="<?php echo e(asset('assets/images/3.jpg')); ?>" alt="Client Avatar">
                                </span>
                                <span class="avatar rounded-circle">
                        ...
                        <div class="wptb--rating-label">Facilitating Smooth & Fast Bank Account Approvals</div>
                ...
                <div class="wptb-why-choose--inner">
                    <div class="row g-0">
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Tailored Banking Solutions</h3>
                                    <p class="wptb-item--description mb-0">Personalized bank account opening assistance for individuals and businesses tailored to UAE, UK, USA, Canada, and Singapore banking requirements.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Streamlined Documentation & Procedures</h3>
                                    <p class="wptb-item--description mb-0">Expert handling of documentation and bank application processes to ensure quick, hassle-free approvals and account activation.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Competitive & Transparent Fees</h3>
                                    <p class="wptb-item--description mb-0">Clear pricing with no hidden costs, providing affordable assistance for opening bank accounts internationally.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description mb-0">Complete support from application to account setup and ongoing banking compliance, helping you manage your finances effortlessly.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Deep Understanding of Banking Regulations</h3>
                                    <p class="wptb-item--description mb-0">Expert knowledge of banking rules and compliance in UAE, UK, USA, Canada, and Singapore to ensure your account setup meets all legal requirements.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-12 p-0">
                <div class="prt-processbox-wrapper" style="display: flex; justify-content: space-between;">
                    <div class="prt-processbox processbox-03" style="width: 57%; height: auto; overflow: scroll;">
                        <div class="">
                            <h2 class="title m-0" style="font-size: 26px;">Some of our <span>Bank Account Opening</span> Highlights & Features</h2>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Global Banking Expertise</h3>
                                </div>
                                <div class="prt-box-description">
                                    We provide expert guidance for opening personal and business bank accounts across UAE, UK, USA, Canada, and Singapore, tailored to each market’s requirements.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                ...
                                <div class="prt-box-description">
                                    We assist with preparation and verification of all required documents to ensure smooth and fast bank account approvals without common delays.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Wide Network of Banking Partners</h3>
                                </div>
                                <div class="prt-box-description">
                                    Our relationships with leading banks enable us to facilitate accounts quickly and provide options best suited for your business or personal needs.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                ...
                                <div class="prt-box-description">
                                    We ensure all banking applications meet the strictest regulatory standards in each country, minimizing rejection risks and ensuring long-term account usability.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Personalized Account Selection</h3>
                                </div>
                                <div class="prt-box-description">
                                    We help you select the best bank account type—personal, corporate, multi-currency, or specialized accounts—aligned with your financial and business goals.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                ...
                                <div class="prt-box-description">
                                    Affordable fees and clear pricing with no hidden costs ensure you get high value and smooth banking onboarding experience.
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/bank-account-assistance.blade.php ENDPATH**/ ?>