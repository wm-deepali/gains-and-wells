...
<?php $__env->startSection('content'); ?>
	...
	<main>
		...
		<div class="uk-section uk-padding-remove-vertical in-slideshow-gradient">
			<div class="in-slideshow" data-uk-slideshow>
				<ul class="uk-slideshow-items uk-light">
					...
					<li>
						<div class="uk-position-cover">
							<img src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-slideshow-image-3.jpg" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
						</div>
						<span></span>
						<div class="uk-container">
							<div class="uk-grid" data-uk-grid>
			...
			<div class="uk-container">
				<div class="uk-grid uk-grid-divider uk-child-width-1-2@s uk-child-width-1-4@m in-margin-top@s in-margin-bottom@s" data-uk-grid>
					<div>
						<div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
							<div class="uk-width-auto">
								<img src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-wave-icon-1.svg" alt="wave-icon" width="48" height="48" data-uk-img>
							</div>
					...
					<div>
						<div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
							<div class="uk-width-auto">
								<img src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-wave-icon-2.svg" alt="wave-icon" width="48" height="48" data-uk-img>
							</div>
							<div class="uk-width-expand">
					...
					<div>
						<div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
							<div class="uk-width-auto">
								<img src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-wave-icon-3.svg" alt="wave-icon" width="48" height="48" data-uk-img>
							</div>
							<div class="uk-width-expand">
					...
					<div>
						<div class="uk-grid uk-grid-small uk-flex uk-flex-middle">
							<div class="uk-width-auto">
								<img src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-wave-icon-4.svg" alt="wave-icon" width="48" height="48" data-uk-img>
							</div>
							<div class="uk-width-expand">
			...
			<div class="uk-container">
				...
				<div class="uk-grid-medium uk-grid-match" data-uk-grid>
					<div class="uk-width-1-2@s uk-width-1-4@m">
						<div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-background-contain uk-background-bottom-center" style="background-image: url(<?php echo e(asset('front_assets')); ?>/img/in-wave-card-bg-1.png);">
					...
					<div class="uk-width-1-2@s uk-width-1-4@m">
						<div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-background-contain uk-background-bottom-center" style="background-image: url(<?php echo e(asset('front_assets')); ?>/img/in-wave-card-bg-2.png);">
							<h5 class="uk-margin-remove">
					...
					<div class="uk-width-1-2@s uk-width-1-4@m">
						<div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-background-contain uk-background-bottom-center" style="background-image: url(<?php echo e(asset('front_assets')); ?>/img/in-wave-card-bg-3.png);">
							<h5 class="uk-margin-remove">
					...
					<div class="uk-width-1-2@s uk-width-1-4@m">
						<div class="uk-card uk-card-default uk-card-body uk-border-rounded uk-background-contain uk-background-bottom-center" style="background-image: url(<?php echo e(asset('front_assets')); ?>/img/in-wave-card-bg-4.png);">
							<h5 class="uk-margin-remove">
		...
		<!-- section content end -->
		<!-- section content begin -->
		<div class="uk-section uk-section-muted uk-background-contain uk-background-center in-wave-3" style="background-image: url(<?php echo e(asset('front_assets')); ?>/img/in-wave-background-1.png);" data-uk-parallax="bgy: -200">
			<div class="uk-container">
				<div class="uk-grid-large uk-flex uk-flex-middle" data-uk-grid>
					<div class="uk-width-1-2@m">
						<img class="uk-margin-bottom" src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-wave-icon-5.svg" alt="wave-icon" width="64" height="64" data-uk-img>
						...
						<div class="uk-grid-medium uk-child-width-1-2@s uk-child-width-1-3@m uk-text-center uk-margin-medium-top" data-uk-grid>
							<div>
								<div class="uk-card uk-card-default uk-card-body uk-border-rounded">
									<img class="uk-margin-remove-bottom" src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-wave-icon-6.svg" alt="wave-icon" width="52" height="52" data-uk-img>
									<h5 class="uk-margin-small-top">Strategies & Discussions</h5>
								</div>
							</div>
							<div>
								<div class="uk-card uk-card-default uk-card-body uk-border-rounded">
									<img class="uk-margin-remove-bottom" src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-wave-icon-7.svg" alt="wave-icon" width="52" height="52" data-uk-img>
					...
					<div class="uk-width-1-2@m">
						<div class="uk-inline uk-dark in-wave-video uk-margin-small-bottom">
							<img class="uk-border-rounded uk-width-1-1" src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-wave-image-1.jpg" alt="wave-video" width="533" height="355" data-uk-img>
				...
				<div class="uk-grid uk-flex uk-flex-center">
					...
					<div class="uk-width-1-1">
						<div class="uk-grid-medium uk-child-width-1-2@s uk-child-width-1-5@m uk-text-center uk-margin-large-top" data-uk-grid>
							<div>
								<img src="<?php echo e(asset('front_assets')); ?>/img/in-lazy.gif" data-src="<?php echo e(asset('front_assets')); ?>/img/in-wave-award.svg" alt="wave-award" width="71" height="58" data-uk-img>
		...
		<div class="uk-section uk-section-default uk-padding-remove-vertical in-wave-5 in-offset-bottom-30">
			<div class="uk-container">
				<div class="uk-grid">
					<div class="uk-width-1-1 uk-background-contain uk-background-center-right uk-background-image@s" style="background-image: url(<?php echo e(asset('front_assets')); ?>/img/in-wave-mockup-1.png);">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/gains-and-well.tpmhelpinghand.com/resources/views/front/index-2.blade.php ENDPATH**/ ?>