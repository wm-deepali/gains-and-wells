        ...
        <div class="row justify-content-center mx-80">
            <div class="col-sm-6">
                <div class="left-side-container-img">
                    <img src="<?php echo e(asset('front_assets')); ?>/img/gainsandwells-logo1-.png">
                </div>
            </div>
            <div class="col-sm-6">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\web-mingo-project\gains-and-wells\resources\views/auth/login.blade.php ENDPATH**/ ?>