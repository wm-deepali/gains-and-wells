                        ...
                        <div class="uk-flex uk-flex-left">
                            ...
                            <div>
                                ...
                                <p class="uk-margin-remove-bottom">At vero eos etme accusamus iusto odio ent dignissimos
                                    deleniti atque corrupti quos ducimus moll quilla blanditiis expedita est distinctio.</p>
                            </div>
                        </div>
                        <div class="uk-flex uk-flex-left">
                            <div class="uk-margin-right">
                ...
                <div class="uk-grid">
                    <div class="uk-width-1-1">
                        <div class="uk-card uk-card-default uk-border-rounded uk-background-center uk-background-contain uk-background-image@m"
                            style="background-image: url(img/blockit/in-team-background-1.html); background-position-y: calc(50% + -7.53px);"
                            ...
                            <div class="uk-card-body">
                                ...
                                <div class="uk-grid uk-child-width-1-2@m uk-margin-medium-top" data-uk-grid="">
                                    <div class="uk-flex uk-flex-left uk-first-column">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center" src="https://www.indonez.com/html-demo/wave/img/blockit/in-team-1.png" alt="image-team"
                                                width="300">
                                        </div>
                                        <div>
                                            <p
                                    ...
                                    <div class="uk-flex uk-flex-left">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center" src="https://www.indonez.com/html-demo/wave/img/blockit/in-team-2.png" alt="image-team"
                                                width="300">
                                        </div>
                                        <div>
                                            <p
                                    ...
                                    <div class="uk-flex uk-flex-left uk-grid-margin uk-first-column">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center" src="https://www.indonez.com/html-demo/wave/img/blockit/in-team-3.png" alt="image-team"
                                                width="300">
                                        </div>
                                        <div>
                                            <p
                                    ...
                                    <div class="uk-flex uk-flex-left uk-grid-margin">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center" src="https://www.indonez.com/html-demo/wave/img/blockit/in-team-4.png" alt="image-team"
                                                width="300">
                                        </div>
                                        <div>
                                            <p
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/gains-and-well.tpmhelpinghand.com/resources/views/front/about-us.blade.php ENDPATH**/ ?>