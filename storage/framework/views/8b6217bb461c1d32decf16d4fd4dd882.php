...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Expert Advisory Services <span> to Drive </span> Strategic Growth & Innovation </h1>
<button class="cost-calculate-banner animated-button" data-bs-toggle="offcanvas" href="#offcanvasExample">
    ...
    <div class="top-banner-bank-it p-15">
            <div class="top-banner-title" style=" width:61%;">
                <h1 style="color: #003760;"><span>Expert Advisory Services  <span style="color: #f36f27;"></span> to Drive<span
                            style="color: #f36f27;"> Strategic Growth & Innovation  </span> </span> </h1>
                <p style="color: #003760;">Our advisory services are tailored to help businesses navigate challenges, seize new opportunities, and make smarter decisions. With deep industry knowledge and a future-focused approach, we guide you through strategy, operations, financial planning, and transformation initiatives that unlock real business value.
                </p>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/advisory-service.blade.php ENDPATH**/ ?>