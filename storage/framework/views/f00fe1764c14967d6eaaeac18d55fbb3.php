...
<!-- page-title -->
<div class="mobile-top-index-banner-freezone" style=" background-image: url('<?php echo e(asset('assets/images/sarjha-media.png')); ?>');">
...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Sharjah Media City (SHAMS) <span>Free Zone Company </span> Formation</h1>
                    ...
                    <ul class="prt-list style2" style="color: rgb(0, 60, 255);">
                        <li style="color: rgb(0, 60, 255);">
                            ...
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);">Benefit from affordable packages.</span>
                        </li>
                        <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);"> 100% ownership, and flexible office options.</span>
                        </li>
        ...
        <div class="top-banner-bank-freezone-shams">
            <div class="top-banner-title">
                <h1 style="font-size: 44px; font-weight: 600;"><span style="color: rgb(0, 60, 255);">Sharjah Media City (SHAMS) </span><br/> <span style="color: rgb(255, 123, 0);"> Free Zone Company </span><span style="color: rgb(0, 60, 255);"> Formation</span></h1>
                <p style="color: rgb(128, 128, 128);">Launch your creative business in SHAMS – a dynamic <br>hub for media, digital, and tech ventures.</p>
                <div class="position-relative mb-15">
                            ...
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Company Setup
                                            in Dubai SHAMS</h3>
                                        <h2 class="title">How To Setup A <span>Company in</span> Sharjah Media City Free Zone, UAE?</h2>
                                    </div>
                                    <div class="title-desc">
                                        <p> SHAMS Free Zone is a forward-thinking business hub in Sharjah focused on media, digital, and creative industries. It offers a fast and cost-effective setup with a wide range of business activities, including service, trade, and freelance licenses. SHAMS supports entrepreneurs and startups with shared workspaces, scalable solutions, and full foreign ownership, making it a top choice for those in creative sectors.</p>
                                    </div>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/shams.blade.php ENDPATH**/ ?>