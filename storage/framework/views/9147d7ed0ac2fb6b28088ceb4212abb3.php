<div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
        ...
        <form class="form form-horizontal" method="POST" action="<?php echo e(route('admin.manage-faq.store')); ?>" enctype="multipart/form-data">
...
</script><?php /**PATH /home/tpmhelpinghand/public_html/gains-and-well.tpmhelpinghand.com/resources/views/admin/faqs/ajax/create.blade.php ENDPATH**/ ?>