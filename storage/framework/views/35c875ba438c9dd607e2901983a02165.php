...
<main>
			...
			<div class="uk-container">
				<div class="uk-grid" data-uk-grid>
					<div class="uk-width-3-5@m">
						...
						<i class="fas fa-long-arrow-alt-right fa-sm uk-margin-small-left uk-margin-small-right"></i>
						<span class="uk-label in-label-small">Trade</span>
					</div>
		...
		<div class="uk-section">
			<div class="uk-container">
				<div class="uk-grid">
					<div class="uk-width-1-1">
						<div class="uk-card uk-card-primary uk-box-shadow-small uk-border-rounded uk-background-cover" style="background-image: url(<?php echo e(asset('front_assets')); ?>/img/blockit/in-card-background-1.html);">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/gains-and-well.tpmhelpinghand.com/resources/views/front/education.blade.php ENDPATH**/ ?>