...
<div class="mobile-top-index-banner-freezone" style=" background-image: url('<?php echo e(asset('assets/images/anc-mobile.png')); ?>');">
...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">ANC Company Formation <span> Get License in 2 Hours Lowest Price Guaranteed </span> Starts AED 4,888</h1>
                    ...
                    <ul class="prt-list style2" style="color: rgb(0, 60, 255);">
                        <li style="color: rgb(0, 60, 255);">
                            ...
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);"> Ideal for professionals, consultants, and businesses looking for a trusted base.</span>
                        </li>
                        <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);"> Hassle Free Setup.</span>
                        </li>
...
<!-- page-title -->
        <div class="top-banner-bank-freezone-anc">
            <div class="top-banner-title">
                <h1 style="font-size: 44px; font-weight: 600;"><span style="color: rgb(0, 60, 255);">ANC Company Formation</span><br /> <span style="color: rgb(255, 123, 0);">Get License in 2 Hours</span> </br><span
                        style="color: rgb(0, 60, 255);"> Lowest Price Guaranteed</span> </br><span style="color: rgb(255, 123, 0);">Starts AED 4,888</span></h1>
                        <p style="color: rgb(128, 128, 128);"> Set up your venture in ANC Free Zone — a prestigious business environment in Abu Dhabi.</p>
                <div class="position-relative mb-15">
                    ...
                    <ul class="prt-list style2" style="color: rgb(0, 60, 255);">
                        ...
                        <!-- <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);">Transfer permanent
                                resident visa</span>
                        </li> -->
                    </ul>
                            ...
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Company Setup
                                            in ANC</h3>
                                        <h2 class="title">How To Setup A <span>Company in</span> Abu Dhabi National
Company Free Zone, UAE?</h2>
                                    </div>
                                    <div class="title-desc">
                                        <p> ANC Free Zone (Abu Dhabi National Company) offers businesses a reputable and secure platform for growth in the capital of the UAE. With simplified licensing, strategic location, and professional support services, ANC is tailored for consultants, freelancers, and service-based businesses.</p>
                                    </div>
                                            ...
                                            <div class="featured-icon-box style4">
                                                ...
                                                <div class="featured-content">
                                                    ...
                                                    <div class="mr-30 mb-25 mt-3 res-991-mr-0 res-991-mb-0">
                                                        <a class="prt-btn prt-btn-size-sm  prt-btn-style-fill prt-btn-color-skincolor"
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ashtonwell/public_html/resources/views/front/anc.blade.php ENDPATH**/ ?>