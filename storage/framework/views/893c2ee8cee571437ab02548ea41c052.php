...
<li class="breadcrumb-item active">Package Enquiries 
</li>
</ol>
</div>
...
<tbody> <?php $i=1; ?>
        ...
        <tr>
           ...
           <td> <?php echo e($business->package->name ?? 'NA'); ?>  </td>
         <td><?php echo e($business->name); ?> </br>
            <?php echo e($business->email); ?> </br>
            <?php echo e($business->mobile); ?></td>
    ...
    function deleteConfirmation(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `<?php echo e(URL::to('admin/manage-packagedeatils/${id}')); ?>`,
                    type: "DELETE",
                    dataType: "json",
...
<?php /**PATH /home/ashtonwell/public_html/resources/views/admin/packagedeatils/index.blade.php ENDPATH**/ ?>