...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Strategic Tax <span> Planning </span> for Smarter Financial Decisions</h1>
    ...
    <div class="top-banner-bank-it p-15">
            <div class="top-banner-title" style=" width:61%;">
                <h1 style="color: #000;"><span>Strategic Tax  <span style="color: #000;"></span> Planning for<span
                            style="color: #b12e5f;"> Smarter Financial Decisions </span> </span> </h1>
                <p style="color: #000;font-size:18px;">Minimize tax liability and maximize savings with our expert tax planning services. We help individuals, startups, and businesses in India and globally stay compliant while planning smarter for growth.
                </p>
                <div class="position-relative mb-15">
                    ...
                    <ul class="prt-list style2" style="color: rgb(0, 60, 255);">
                        <li style="color: rgb(0, 60, 255);">
                            ...
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);"> Annual & Quarterly Tax Planning (Direct & Indirect)</span>
                        </li>
                        <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);">GST Planning & Optimization</span>
                        </li>
                        <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);"> International Tax Advisory (Including NRIs, Expat Taxation)</span>
                        </li>
                    </ul>
  ...
  <img src="<?php echo e(asset('assets/images/taxation.png')); ?>" class="main-image" alt="Website Image" width="220px">
 ...
 <!--       </div>-->
                        ...
                        <div class="col-lg-6 align-self-center ">
                            <div class="bg-base-grey text-center text-lg-start res-991-pt-20">
                                <div class="prt_single_image-wrapper res-991-ml-20 res-991-mr-20">
                                    <img class="img-fluid" src="<?php echo e(asset('assets/images/tax-img.png')); ?>" alt="single-img-9">
                                </div>
                                <div class="spacing-18">
                                    <h3 class="fs-20 mb-0">One Stop Solution for <strong class="text-base-skin"> Taxation in India &</strong> Abroad!</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 align-self-center">
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Tax Planning</h3>
                                        <h2 class="title">Learn more about our  <span>Taxation Services</span></h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>Our <b>Taxation Planning</b>    Services go beyond filing returns—we help you make strategic financial decisions that reduce tax burdens while ensuring complete regulatory compliance.</p> </br>
                                        <p>We specialize in personalized tax planning for both domestic (Indian) and international clients, including individuals, startups, SMEs, and large businesses. Whether it’s optimizing your capital structure or navigating international taxation laws like DTAA, GST, or transfer pricing, our experienced team ensures you're always a step ahead.</p>
                                    </div>
                                        ...
                                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                                            ...
                                            <div class="featured-content">
                                                <div class="featured-title">
                                                    <h3>Complianc Ready</h3>
                                                </div>
                                                <div class="featured-desc">
                                                    <p>Services offered are truly based on Compliance in Indian, and Abroad</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="title-page col-10 border-bottom pb-3 mb-15">
        <h2>Proactive Tax <br> Planning That Aligns With Your Business Goals</h2>
        <p class="text-center" style="color: #abafb5;">We don’t just calculate your taxes—we design strategies to reduce them. Get personalized tax planning solutions aligned with Indian and international tax laws.</p>
    </div>
    <div class="row col-10">
        <div class="col-md-6 res-767-mb-30">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">Compliance + Optimization
                        </h3>
                    </div>
                    <div class="featured-desc">
                        <p> Ensure full legal compliance while uncovering areas where tax outflow can be reduced.
        ...
        <div class="col-md-6">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">Strategic Investment Planning</h3>
                    </div>
                    <div class="featured-desc">
                        <p >Plan your investments smartly across FDs, ELSS, PPF, NPS, insurance, and more to gain maximum tax benefits.</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="prt-processbox processbox-03" style="width: 57%; height: auto; overflow: scroll;">
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Tailored Tax Plans for Individuals & Businesses</h3>
                                            </div>
                                            <div class="prt-box-description"> We evaluate your income sources and business structure to build a personalized tax-saving strategy..</div>
                                        </div>
                                    </div>
                                    <div class="processbox-content">
                                        <div class="prt-number-box">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Domestic & International Tax Expertise
                                                </h3>
                                            </div>
                                            <div class="prt-box-description"> Our team is well-versed with Indian laws (Income Tax, GST) as well as international regulations (DTAA, FATCA, Transfer Pricing).</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Startup & SME Focus
                                                </h3>
                                            </div>
                                            <div class="prt-box-description">We assist startups in saving taxes on ESOPs, funding structures, and founder income through effective planning..</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            ...
                                            <div class="prt-box-description">Smart tax-saving on capital gains from property, equity, mutual funds, and inheritance.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Advance Tax & TDS Management</h3>
                                            </div>
                                            <div class="prt-box-description"> Avoid penalties and interest by calculating and paying taxes in advance with precision.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Real-Time Investment Advisory
                                                </h3>
                                            </div>
                                            <div class="prt-box-description">Receive timely advice on eligible deductions under 80C, 80D, 24(b), and more.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Assessment & Scrutiny Handling</h3>
                                            </div>
                                            <div class="prt-box-description"> In case of notices, assessments, or tax queries—we prepare and represent on your behalf.</div>
                                        </div>
                                    </div>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/taxation.blade.php ENDPATH**/ ?>