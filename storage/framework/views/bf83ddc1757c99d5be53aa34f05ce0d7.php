...
<main>
			...
			<div class="uk-container">
				<div class="uk-grid-collapse uk-position-relative" data-uk-grid>
					<div class="uk-position-bottom-right">
						<img src="<?php echo e(asset('front_assets')); ?>/img/in-wave-background-2.png" alt="wave-hq" width="540" height="513">
					</div>
		...
		<!-- section content end -->
		<!-- section content begin -->
		<div class="uk-section uk-section-muted uk-background-cover uk-background-center-center in-wave-7" style="background-image: url(<?php echo e(asset('front_assets')); ?>/img/in-wave-background-3.jpg);">
			<div class="uk-container">
							...
							<div>
								<ul class="uk-list uk-list-divider in-front-news">
									<li>
										<div class="uk-grid-collapse uk-flex uk-flex-middle" data-uk-grid>
											<div class="uk-width-auto">
												<img class="uk-border-rounded" src="<?php echo e(asset('front_assets')); ?>/img/in-widget-image-1.jpg" alt="sample-image" width="94" height="94">
											</div>
									...
									<li>
										<div class="uk-grid-collapse uk-flex uk-flex-middle" data-uk-grid>
											<div class="uk-width-auto">
												<img class="uk-border-rounded" src="<?php echo e(asset('front_assets')); ?>/img/in-widget-image-2.jpg" alt="sample-image" width="94" height="94">
											</div>
											<div class="uk-width-expand uk-margin-medium-left">
												<a href="#">
									...
									<li>
										<div class="uk-grid-collapse uk-flex uk-flex-middle" data-uk-grid>
											<div class="uk-width-auto">
												<img class="uk-border-rounded" src="<?php echo e(asset('front_assets')); ?>/img/in-widget-image-3.jpg" alt="sample-image" width="94" height="94">
											</div>
											<div class="uk-width-expand uk-margin-medium-left">
												<a href="#">
				...
				<div class="uk-grid uk-flex uk-flex-center">
					<div class="uk-width-3-4@m">
						<div class="uk-grid-large uk-child-width-1-2@s uk-child-width-1-2@m uk-flex uk-flex-middle" data-uk-grid>
							<div>
								<img src="<?php echo e(asset('front_assets')); ?>/img/in-wave-mockup-2.png" alt="wave-mockup" width="395" height="509">
							</div>
							<div>
		...
		<div class="uk-section uk-section-primary in-wave-10 in-offset-bottom-30">
			<div class="uk-container">
				<div class="uk-grid uk-position-relative uk-flex uk-flex-middle">
					<div class="uk-position-bottom-right">
						<img src="<?php echo e(asset('front_assets')); ?>/img/in-wave-background-4.svg" alt="wave-hq" width="500" height="189">
					</div>
					<div class="uk-width-auto@m uk-text-center">
						<img src="<?php echo e(asset('front_assets')); ?>/img/in-wave-icon-10.svg" alt="wave-icon" width="96" height="96">
					</div>
					<div class="uk-width-3-5@m">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/gains-and-well.tpmhelpinghand.com/resources/views/front/homepage2.blade.php ENDPATH**/ ?>