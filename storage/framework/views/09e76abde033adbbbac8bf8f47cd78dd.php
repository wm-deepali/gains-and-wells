...
<tbody> <?php $i=1; ?>
        ...
        <tr>
         ...
         <td> <?php echo e($business->name); ?></td>
              <td>
   <img src="<?php echo e(asset('storage/blogs/' . $business->image)); ?>" width="100" height="80" alt="Offer Image">

</td>
            <td> <?php echo e($business->status == 0 ? 'Active' : 'Inactive'); ?></td>
    ...
    function deleteConfirmation(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `<?php echo e(URL::to('admin/manage-offers/${id}')); ?>`,
                    type: "DELETE",
                    dataType: "json",
...
<?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/admin/offers/index.blade.php ENDPATH**/ ?>