                ...
                <div class="uk-grid">
                    <div class="uk-width-1-1 in-content-10">
                        <div class="uk-card uk-card-primary uk-card-body uk-border-rounded uk-background-bottom-left uk-background-contain"
                            style="background-image: url(<?php echo e(asset('front_assets')); ?>/img/blockit/in-content-10-image.html);">
                                    ...
                                    <div class="uk-grid" data-uk-grid>
                                        ...
                                        <div class="uk-width-expand@m in-margin-top-10@s">
                                            ...
                                            <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                                src="<?php echo e(asset('front_assets')); ?>/img/blockit/in-team-7.html" width="40" height="40" alt="author-image">
                                ...
                                <a href="#"
                                    ...
                                    <div class="uk-grid" data-uk-grid>
                                        ...
                                        <div class="uk-width-expand@m in-margin-top-10@s">
                                            ...
                                            <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                                src="<?php echo e(asset('front_assets')); ?>/img/blockit/in-team-8.html" width="40" height="40" alt="author-image">
                                ...
                                <a href="#"
                                    ...
                                    <div class="uk-grid" data-uk-grid>
                                        ...
                                        <div class="uk-width-expand@m in-margin-top-10@s">
                                            ...
                                            <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                                src="<?php echo e(asset('front_assets')); ?>/img/blockit/in-team-6.html" width="40" height="40" alt="author-image">
                                ...
                                <a href="#"
                                    ...
                                    <div class="uk-grid" data-uk-grid>
                                        ...
                                        <div class="uk-width-expand@m in-margin-top-10@s">
                                            ...
                                            <img class="uk-border-pill uk-background-muted uk-float-left uk-margin-remove-adjacent uk-margin-small-right"
                                                src="<?php echo e(asset('front_assets')); ?>/img/blockit/in-team-3.html" width="40" height="40" alt="author-image">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/gains-and-well.tpmhelpinghand.com/resources/views/front/help-center.blade.php ENDPATH**/ ?>