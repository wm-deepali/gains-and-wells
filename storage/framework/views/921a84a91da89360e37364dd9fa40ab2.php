...
Company Formation & Financial Services
...
<div class="top-banner-bank-website-offer">
            ...
            <div class="top-banner-title">
                <h1 class="banner-title-top-wesite"> Ready to Grow Your Business? Let’s Make It Happen!
                    <span> with Our <br> Exclusive offers
                    </span>
                </h1>
                <div class="position-relative mb-15" style="width: 100%;color: gray;">

                    <p style="width: 100%;color: gray;">From Accounts & Finance to GST, VAT, TDS compliance, HRMS, and expert Financial Advisory — we provide end-to-end solutions tailored for your business success. Planning to expand abroad? Our comprehensive Business Setup and Startup & Investor Visa services cover UAE, UK, USA, Canada, and Singapore.</p>
                            ...
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title" style="margin-top:30px;">
                                    <div class="title-header">
                                        ...
                                        <h2 class="title text-center">Browse Our Exclusive <span>Offer</span> </br>and Choose the Best Fit for Your Business Needs!"</h2>
                                    </div>
                                    <div class="title-desc text-center">
                                        <p> Discover tailored solutions designed to simplify your business operations and fuel growth.
Explore our exclusive offers and find the perfect service package that fits your unique needs.
                        ...
                        <div class="offer-card-design ">
                        <img class="img-fluid" src="<?php echo e(URL::to('public/storage/blogs/' . $offer->image)); ?>" alt="Offer Image">
                        <div class="card-overlay" >
                            <button class="overlay-btn" onclick="openModal('<?php echo e($offer->id); ?>')">Register Now</button>
            ...
            <?php $__currentLoopData = $offers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $offer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  <div id="modal-<?php echo e($offer->id); ?>" class="custom-modal">
    <div class="custom-modal-content">
      <span class="close-btn" onclick="closeModal('<?php echo e($offer->id); ?>')">&times;</span>
      <section class="prt-row contact-us-contact-form-section clearfix">
          <div class="container-fluid">
            <div class="row g-0">
              <!--<div class="col-lg-6">-->
              <!--  <img class="img-fluid prt-equal-height-image" src="<?php echo e(asset('images/bg-image/col-bgimage-37.png')); ?>" alt="col-bgimage-37">-->
              <!--</div>-->
              <div class="col-lg-12">
                <div class="bg-base-grey spacing-25">
                  ...
                  <form action="<?php echo e(route('offer-submit-data')); ?>" method="POST" class="contact_form clearfix oferfrm" id="oferfrm<?php echo e($offer->id); ?>" data-id="<?php echo e($offer->id); ?>">
                    <?php echo csrf_field(); ?>
                     <input type="hidden" id="oferfrm<?php echo e($offer->id); ?>res" value="0">
                   <div class="row">
                      <div class="col-md-12">  
                        <input type="hidden" name="offer_id" id="contactFormModal"  value="<?php echo e($offer->id); ?>">     
                        <input type="hidden" name="p_id"  value="<?php echo e($page->id); ?>">         
                      ...
                      <div class="col-md-12">
                       ...
                       <div class="col-md-12" style="display:flex;">
                           <?php $phonecodes = App\Helpers\Helper::getCountryPhoneCode(); ?>
                      <select id="offcountry_code<?php echo e($offer->id); ?>" data-id="<?php echo e($offer->id); ?>" class="offercode codecountry" name="country_code" required style="width:48%;">
                        <option value="">Select Country Code</option>
                        <?php if(isset($phonecodes) && count($phonecodes)>0): ?>
                        <?php $__currentLoopData = $phonecodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $phonecode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($phonecode->phonecode); ?>"><?php echo e($phonecode->name." (+".$phonecode->phonecode.")"); ?></option>
                        ...
                        <input name="mobile" type="text" id="mobileNumber<?php echo e($offer->id); ?>" placeholder="Mobile Number" oninput="validatePhone(this)" required>
                        <div class="mobile-error" style="color: red; font-size: 14px;"></div>
                        <p id="verifiedBadge<?php echo e($offer->id); ?>" style="color:green;display:none;">Verified</p>
                      </div>
                      
                      <div class="col-12">
                        <input type="tel" name="mobile" id="mobileIn<?php echo e($offer->id); ?>" class="form-control" style="display:none;"/>
                        <input type="text" name="isValid" id="isValidNumber<?php echo e($offer->id); ?>" value="1" class="form-control" style="display:none;"/>
                        <div class="form-group mb-2" id="otpFld<?php echo e($offer->id); ?>" style="display: none;">
                            <input
                                type="text"
                                class="form-control"
                                id="otp<?php echo e($offer->id); ?>"
                                name="otp"
                                placeholder="Enter OTP"
                                maxlength="6"
                            />
                        </div>
                        <button type="button" class="btn btn-primary mb-2" id="sendOtpbt<?php echo e($offer->id); ?>" onclick="sendOffOTP(<?php echo e($offer->id); ?>)" style="display: none;">Send OTP</button>
                        <button type="button" class="btn btn-primary mb-2" id="verifyOtpbt<?php echo e($offer->id); ?>" style="display: none;" onclick="verifyOffOTP(<?php echo e($offer->id); ?>)">Verify</button>
                        <button type="button" class="btn btn-primary mb-2" id="resendOtpbt<?php echo e($offer->id); ?>" onclick="sendOffOTP(<?php echo e($offer->id); ?>)" style="display: none;">Resend OTP</button>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          ...
          <!-- Modal -->
<!-- Modal -->
<!--<div class="modal fade" id="<?php echo e($offer->id); ?>contactFormModal" tabindex="-1" aria-labelledby="contactFormModalLabel" aria-hidden="true">-->
...
<!--                    </div>-->
<!--                  </div>-->
<!--                  <form action="<?php echo e(route('company-setup-offer')); ?>" method="POST" class="contact_form clearfix">-->
<!--                    <?php echo csrf_field(); ?>-->
<!--                    <div class="row">-->
<!--                      <div class="col-md-12">  -->
<!--                        <input type="hidden" name="offer_id" id="contactFormModal" value="<?php echo e($offer->id); ?>">                -->
...
<!--                          <option value="WordPress security">WordPress security</option>-->
                                        ...
                                        <div class="featured-icon-box style13">
                                            ...
                                            <div class="featured-content">
                                                <div class="featured-title">
                                                    <h3>Crafting Solutions Tailored Precisely to Your Vision </h3>
                                                </div>
                                                <div class="featured-desc">
                                                    <p>Your vision guides us — from straightforward websites to sophisticated web applications, we deliver custom-built solutions designed meticulously to meet your unique needs with excellence and attention to detail.</p>
                                                </div>
        ...
        <div class="wptb-heading">
            <div class="wptb-item--inner text-center mb-5">
                ...
                <h1 class="wptb-item--title"> 
                    <span>Expert Guidance Across Diverse Business Needs <br> from Financial Compliance to International Business Setup</span>
                </h1>
            </div>
        </div>
                        ...
                        <div class="wptb-heading">
                            <div class="wptb-item--inner text-center">
                                ...
                                <h1 class="wptb-item--title" style="font-family: 'fontello';"> 
                                    <span>Partner with us for tailored solutions that accelerate your business growth.</span>
                                </h1>
                            </div>
                        </div>
                ...
                <div class="wptb-why-choose--inner">
                    <div class="row g-0">
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description mb-0">From GST, VAT, and TDS compliances to HRMS and financial advisory, we customize services that perfectly fit your business requirements.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description mb-0">We streamline compliances and business setups abroad to ensure timely delivery, so you can focus on growth without delays.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description mb-0">Benefit from competitively priced packages covering accounts, tax compliance, international business setups, and visa assistance with transparent pricing.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Comprehensive Services</h3>
                                    <p class="wptb-item--description mb-0">From local tax compliance to setting up your business in UAE, UK, USA, Canada, and Singapore, plus startup and investor visa facilitation — we cover it all.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Local & Global Expertise</h3>
                                    <p class="wptb-item--description mb-0">With in-depth knowledge of Indian and international regulations, we ensure your business complies and thrives across borders.</p>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/company-setup-offer.blade.php ENDPATH**/ ?>