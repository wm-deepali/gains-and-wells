...
<!-- page-title -->
        <div class="top-banner-bank-freezone-srtip">
            <div class="top-banner-title">
                <h1 style="font-size: 44px; font-weight: 600;"><span style="color: rgb(0, 60, 255);">SRTIP (Sharjah Research, 
                        </span><br /> <span style="color: rgb(255, 123, 0);"> Technology and Innovation Park) </span><span
                        style="color: rgb(0, 60, 255);"><br> Free Zone</span></h1>
                        <p style="color: rgb(128, 128, 128);">Innovate and grow your business at SRTIP — Sharjah’s leading hub for tech, research, and startups.</p>
                <div class="position-relative mb-15">
                    ...
                    <ul class="prt-list style2" style="color: rgb(0, 60, 255);">
                        <li style="color: rgb(0, 60, 255);">
                            ...
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);">Enjoy 100% ownership.</span>
                        </li>
                        <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);">futuristic infrastructure, and a thriving R&D ecosystem.</span>
                        </li>
                        <!-- <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            ...
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Company Setup
                                            in SRTIP (Sharjah Research,
Technology and Innovation Park) Free Zone</h3>
                                        <h2 class="title">How To Setup A <span>Company in</span> SRTIP Free Zone, UAE?</h2>
                                    </div>
                                    <div class="title-desc">
                                        <p><b> SRTIP (Sharjah Research, Technology and Innovation Park)</b> Free Zone  is designed to support innovation-driven businesses, entrepreneurs, and academic collaborations. Located near the University City of Sharjah, it focuses on sectors like AI, robotics, 3D printing, renewable energy, and education. SRTIP offers full foreign ownership, cutting-edge facilities, and a supportive ecosystem ideal for startups and high-tech ventures looking to shape the future from the UAE.</p>
                                    </div>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ashtonwell/public_html/resources/views/front/srtip.blade.php ENDPATH**/ ?>