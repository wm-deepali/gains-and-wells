...
<div class="top-banner-bank-website-offer">
    ...
    <h1 class="banner-title-top-wesite">
        Secure Your Future with a Permanent<br>
        <span> Residency Visa</span>
    </h1>
    <div class="position-relative mb-15" style="width: 100%; color: gray;">
        <p style="width: 100%; color: gray;">
            Unlock the freedom to live, work, and thrive in your dream country. Our experts guide you through every step of obtaining Permanent Residency in the UAE, USA, UK, Canada, and Singapore—making your global relocation smooth, secure, and stress-free.
        </p>
    </div>
    <button class="cost-calculate-banner1" data-bs-toggle="offcanvas" href="#offcanvasExample">
        Book Free Consultation
            ...
            <div class="mb-lg-3 mb-3 d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="p-0">Permanent Residency Visa</p>
                    <h2>Get a Quote</h2>
                </div>
            </div>
   ...
   <div class="col-md-12" style="display:flex;gap:15px;">
    ...
    <div class="title-header">
        <h2 class="title text-center">
            Your Gateway to <span>Permanent Residency</span> <br> in Top Global Destinations
        </h2>
    </div>
    <div class="title-desc text-center">
        <p>
            Achieve the freedom to live, work, and build your future abroad with our expert Permanent Residency (PR) visa solutions. 
            Whether your dream is to settle in the UAE, USA, UK, Canada, or Singapore, we provide clear guidance on eligibility, 
            documentation, and application procedures. 
            From skilled migration and investment pathways to family sponsorships and specialized PR programs, 
            our team ensures a smooth, compliant, and stress-free journey to securing your residency status. 
            Let us help you make your global relocation a reality—faster and with complete peace of mind.
        </p>
    </div>
</div>
<!-- section title end -->
    ...
    <div class="text-center" style="margin-bottom: 30px;">
        <h2 style="color: #fff;">Your Pathway to Global Permanent Residency</h2>
        <p style="color: #ccc; max-width: 900px; margin: auto;">
            We provide expert guidance and complete support to help you secure Permanent Residency in the UAE, USA, UK, Canada, and Singapore. 
            From eligibility assessment to post-approval settlement, our solutions are designed to make your transition smooth and stress-free.
        </p>
    </div>
    ...
    <div class="row col-10">
            ...
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">PR Eligibility Assessment</h3>
                    </div>
                    <div class="featured-desc">
                        <p>We carefully evaluate your profile to identify the most suitable PR pathway—whether through skilled migration, investment, or family sponsorship.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 residency-key-points">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">Tailored PR Application Guidance</h3>
                    </div>
                    <div class="featured-desc">
                        <p>We guide you through country-specific PR requirements, ensuring all documentation is accurate and your application is strategically prepared.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">End-to-End PR Process Support</h3>
                    </div>
                    <div class="featured-desc">
                        <p>We handle the full PR process—from compiling documents and submitting your application to liaising with authorities and tracking progress.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">Post-Approval Settlement Services</h3>
                    </div>
                    <div class="featured-desc">
                        <p>Once your PR is granted, we assist with relocation, local registration, compliance, and integration to help you settle confidently in your new country.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <!-- Visa Cards Starts -->
            <div class="service-page-service-card slick_slider mb-25 mt-30" 
            data-slick='{"slidesToShow": 4, "slidesToScroll": 1, "arrows":true, "autoplay":true, "infinite":true, "responsive": [{"breakpoint":1200,"settings":{"slidesToShow": 3}}, {"breakpoint":1024,"settings":{"slidesToShow": 3}}, {"breakpoint":777,"settings":{"slidesToShow": 2}}, {"breakpoint":575,"settings":{"slidesToShow": 1}}, {"breakpoint":420,"settings":{"slidesToShow": 1}}]}' >
                
                <div class="service-p-card">
                                        <img src="<?php echo e(asset('assets/images/uae-golden.png')); ?>" width="170px" style="border-radius:50%;">
                    <h3>UAE & Dubai</h3>
                    <button class="service-p-btn">Register Now</button>

                </div>
                <div class="service-p-card">
                    <img src="<?php echo e(asset('assets/images/usa-st.png')); ?>" width="170px" style="border-radius:50%;">
                    <h3>USA</h3>
                    <button class="service-p-btn">Register Now</button>

                </div>
                <div class="service-p-card">
<img src="<?php echo e(asset('assets/images/uk-startup.png')); ?>" width="170px" style="border-radius:50%;">
                    <h3> United Kingdom (UK)</h3>
                    <button class="service-p-btn">Register Now</button>

                </div>
                <div class="service-p-card">
                                        <img src="<?php echo e(asset('assets/images/canada-startup.png')); ?>" width="170px" style="border-radius:50%;">
                    <h3>Canada</h3>
                    <button class="service-p-btn">Register Now</button>

                </div>
                <div class="service-p-card">
                    <img src="<?php echo e(asset('assets/images/singapore-startup.png')); ?>" width="170px" style="border-radius:50%;">
                    <h3>Singapore</h3>
                    <button class="service-p-btn">Register Now</button>
...
<div class="featured-content">
    <div class="featured-title">
        <h3>Secure Your Permanent Residency & Build Your Future Abroad</h3>
    </div>
    <div class="featured-desc">
        <p>Get expert guidance to apply for Permanent Residency in top destinations like Canada, Singapore, UAE, UK, and USA.  
        Our team ensures a smooth process from eligibility assessment to final approval, helping you settle and thrive in your new country.</p>
    </div>
   ...
   <section class="prt-row service02-about-section">
                        ...
                        <div class="col-lg-6 align-self-center ">
                            <div class="bg-base-grey text-center text-lg-start res-991-pt-20">
                                ...
                                <div class="spacing-18">
                                    <h3 class="fs-20 mb-0">One Stop Solution for <strong class="text-base-skin"> All Your Residency Visa </strong> Needs</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 align-self-center">
    ...
    <div class="title-header">
        <h3>Permanent Residency Visa Services</h3>
        <h2 class="title">Helping <span>Individuals & Families</span> Settle Abroad</h2>
    </div>
    <div class="title-desc">
        <p>At <b>Your Company Name</b>, we provide expert guidance and complete support for individuals and families seeking Permanent Residency in leading destinations such as UAE, USA, UK, Canada, and Singapore.</p>
        
        <p>Whether your goal is to secure a stable future, access world-class education, or enjoy better career opportunities, we make the PR application process seamless—handling eligibility checks, documentation, and application submission with precision and care.</p>
    </div>
</div>
        ...
        <div class="wptb-heading">
            <div class="wptb-item--inner text-center mb-5">
                ...
                <h1 class="wptb-item--title">
                    <span>Expert Residency Visa Assistance </br> for a Smooth Move Abroad</span>
                </h1>
            </div>
        </div>
                    ...
                    <div class="wptb-item--inner">
                        <div class="wptb-heading">
                            <div class="wptb-item--inner text-center">
                                <h6 class="wptb-item--subtitle">GLOBAL IMMIGRATION EXPERTISE</h6>
                                <h1 class="wptb-item--title" style="font-family: 'fontello';">
                                    <span>Your Trusted Partner for Residency Visa Success</span>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="wptb--rating-label">Helping Families & Individuals Secure PR Visas</div>
                ...
                <div class="wptb-why-choose--inner">
                    <div class="row g-0">
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Tailored Residency Plans</h3>
                                    <p class="wptb-item--description mb-0">Personalized PR visa solutions designed to meet your long-term settlement goals and eligibility criteria.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Fast & Transparent Process</h3>
                                    <p class="wptb-item--description mb-0">Efficient application handling with clear timelines, keeping you informed at every stage.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Affordable & Clear Pricing</h3>
                                    <p class="wptb-item--description mb-0">Competitive fees with no hidden charges, ensuring complete transparency in your PR journey.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">End-to-End Immigration Support</h3>
                                    <p class="wptb-item--description mb-0">From eligibility checks to post-approval settlement assistance, we guide you at every step.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Global Immigration Knowledge</h3>
                                    <p class="wptb-item--description mb-0">Extensive expertise in PR visa programs for UAE, USA, UK, Canada, and Singapore.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-12 p-0">
                <div class="prt-processbox-wrapper" style="display: flex; justify-content: space-between;">
                    <div class="prt-processbox processbox-03" style="width: 57%; height: auto; overflow: scroll;">
                        <div class="">
                            <h2 class="title m-0" style="font-size: 26px;">Key <span>Features & Benefits</span> of Permanent Residency Visa</h2>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Long-Term Residency Rights</h3>
                                </div>
                                <div class="prt-box-description">
                                    Gain the right to live, work, and study in your chosen country for an extended period without the need for frequent renewals.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                ...
                                <div class="prt-box-description">
                                    Permanent residency often serves as a stepping stone towards full citizenship, offering more rights and privileges over time.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Access to Quality Healthcare & Education</h3>
                                </div>
                                <div class="prt-box-description">
                                    Enjoy access to world-class healthcare systems and educational opportunities for you and your family.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Work & Business Opportunities</h3>
                                </div>
                                <div class="prt-box-description">
                                    Secure the freedom to work or start a business, contributing to the local economy without restrictive visa limitations.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Family Sponsorship Benefits</h3>
                                </div>
                                <div class="prt-box-description">
                                    Permanent residents can often sponsor family members, making it easier for your loved ones to join you.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Stable & Secure Immigration Status</h3>
                                </div>
                                <div class="prt-box-description">
                                    Enjoy peace of mind with a stable immigration status that protects your rights and offers more flexibility compared to temporary visas.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Expert Guidance for Multiple Countries</h3>
                                </div>
                                <div class="prt-box-description">
                                    We provide clear and simple advice tailored for permanent residency in UAE, USA, UK, Canada, and Singapore — helping you choose the best option.
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/permanent-residency-visa.blade.php ENDPATH**/ ?>