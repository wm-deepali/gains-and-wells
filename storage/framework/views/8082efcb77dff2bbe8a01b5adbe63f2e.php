...
<!-- page-title -->
<div class="mobile-top-index-banner-freezone" style=" background-image: url('<?php echo e(asset('assets/images/rakez.png')); ?>');">
...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">RAKEZ (Ras Al Khaimah <span> Economic Zone) </span> Business Setup</h1>
                    ...
                    <ul class="prt-list style2" style="color: rgb(0, 60, 255);">
                        <li style="color: rgb(0, 60, 255);">
                            ...
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);">Ideal for SMEs, freelancers, and manufacturers seeking global reach.</span>
                        </li>
                        <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);"> Enjoy wide range of activities</span>
                        </li>
        ...
        <div class="top-banner-bank-freezone-rakez">
            <div class="top-banner-title">
                <h1 style="font-size: 44px; font-weight: 600;"><span style="color: rgb(0, 60, 255);">RAKEZ (Ras Al Khaimah  </span><br /> <span style="color: rgb(255, 123, 0);"> Economic Zone)</span><span
                        style="color: rgb(0, 60, 255);"><br/> Business Setup</span></h1>
                        <p style="color: rgb(128, 128, 128);"> Build your business with RAKEZ — a powerful free zone offering low-cost<br/> setup and diverse sectors.</p>
                <div class="position-relative mb-15">
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ashtonwell/public_html/resources/views/front/rakez.blade.php ENDPATH**/ ?>