                            ...
                            <div class="uk-card-body">
                                ...
                                <div class="uk-grid uk-child-width-1-2@m uk-margin-medium-top" data-uk-grid="">
                                    <div class="uk-flex uk-flex-left uk-first-column">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center" src="<?php echo e(asset('front_assets')); ?>/img/blockit/in-team-1.html" alt="image-team"
                                                width="300">
                                        </div>
                                        <div>
                                            <p
                                    ...
                                    <div class="uk-flex uk-flex-left">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center" src="<?php echo e(asset('front_assets')); ?>/img/blockit/in-team-2.html" alt="image-team"
                                                width="300">
                                        </div>
                                        <div>
                                            <p
                                    ...
                                    <div class="uk-flex uk-flex-left uk-grid-margin uk-first-column">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center" src="<?php echo e(asset('front_assets')); ?>/img/blockit/in-team-3.html" alt="image-team"
                                                width="300">
                                        </div>
                                        <div>
                                            <p
                                    ...
                                    <div class="uk-flex uk-flex-left uk-grid-margin">
                                        <div class="uk-margin-right">
                                            <img class="uk-align-center" src="<?php echo e(asset('front_assets')); ?>/img/blockit/in-team-4.html" alt="image-team"
                                                width="300">
                                        </div>
                                        <div>
                                            <p
