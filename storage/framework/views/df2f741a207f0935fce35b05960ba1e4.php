...
Startups & Investors Visa Programme
...
<div class="top-banner-bank-website-offer">
            ...
            <div class="top-banner-title">
                <h1 class="banner-title-top-wesite"> Launch Your Business & Secure Your 
                    <br><span> Investor or Startup Visa Today!
                    </span>
                </h1>
                <div class="position-relative mb-15" style="width: 100%;color: gray;">

                    <p style="width: 100%;color: gray;">Discover a range of tailored solutions for Visa needs, Step into global markets with confidence. Get expert guidance on starting your business and obtaining Investor or Startup visas in UAE, USA, UK, Canada, and Singapore.</p>
            ...
            <div class="mb-lg-3 mb-3 d-flex align-items-center">
                ...
                <div>
                    ...
                    <p class="p-0">Startup & Investor Visa Programme</p>
                    <h2>Get a Quote</h2>
                </div>
            </div>
                            ...
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title" style="margin-top:30px;">
                                    <div class="title-header">
                                        ...
                                        <h2 class="title text-center">Comprehensive Startup & Investor <span> Visa Solutions</span> </br>Across Leading Global Markets</h2>
                                    </div>
                                    <div class="title-desc text-center">
                                        <p>We specialize in helping entrepreneurs and investors from India launch and expand their businesses internationally. Whether you’re aiming for the UAE’s Golden Visa, the USA’s EB-5 program, the UK’s Innovator Visa, Canada’s Start-up Visa, or Singapore’s EntrePass, our expert team guides you through every step—from business setup and documentation to visa application and compliance.
Partner with us to simplify your global expansion journey and unlock new growth opportunities with confidence and ease.</p>
                                    </div>
                                </div>
                ...
                <div class="row col-10">
                        ...
                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3 style="color: #fff;">Expert Business Setup Assistance
                                    </h3>
                                </div>
                                <div class="featured-desc">
                                    <p>We help you establish your business smoothly in UAE, USA, UK, Canada, and Singapore—handling all legal, regulatory, and compliance requirements so you can focus on growth.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 residency-key-points">
                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3 style="color: #fff;">Tailored Investor & Startup Visa Guidance</h3>
                                </div>
                                <div class="featured-desc">
                                    <p >Our team offers personalized advice on visa eligibility, documentation, and application strategies to maximize your chances of success in each country’s investor or startup visa programs. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 ">
                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3 style="color: #fff;">End-to-End Application Support</h3>
                                </div>
                                <div class="featured-desc">
                                    <p >From paperwork preparation to submission and follow-ups, we manage the entire visa application process, ensuring accuracy, timeliness, and peace of mind.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 ">
                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                            ...
                            <div class="featured-content">
                                <div class="featured-title">
                                    <h3 style="color: #fff;">Post-Visa Business & Residency Support</h3>
                                </div>
                                <div class="featured-desc">
                                    <p > Once your visa is approved, we assist with business operations, residency compliance, and expansion strategies to help you thrive in your new market.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            data-slick='{"slidesToShow": 4, "slidesToScroll": 1, "arrows":true, "autoplay":true, "infinite":true, "responsive": [{"breakpoint":1200,"settings":{"slidesToShow": 3}}, {"breakpoint":1024,"settings":{"slidesToShow": 3}}, {"breakpoint":777,"settings":{"slidesToShow": 2}}, {"breakpoint":575,"settings":{"slidesToShow": 1}}, {"breakpoint":420,"settings":{"slidesToShow": 1}}]}' >
                ...
                <div class="service-p-card">
                    ...
                    <h3>UAE & Dubai</h3>
                    <a href="<?php echo e(route('uae-startup-investor-golden-visa')); ?>">
                    <button class="service-p-btn">Know More</button>
                    </a>
                ...
                <div class="service-p-card">
                    ...
                    <h3>USA</h3>
                     ...
                     <a href="<?php echo e(route('usa-startup-investor-visa')); ?>">
                    <button class="service-p-btn">Know More</button>
                    </a>
 ...
 <a href="<?php echo e(route('uk-startup-investor-visa')); ?>">
                    <button class="service-p-btn">Know More</button>
                    </a>
                ...
                <div class="service-p-card">
                    ...
                    <h3>Canada</h3>
                     <a href="<?php echo e(route('canada-startup-investor-visa')); ?>">
                    <button class="service-p-btn">Know More</button>
                    </a>
                ...
                <div class="service-p-card">
                    ...
                    <h3>Singapore</h3>
                     <a href="<?php echo e(route('singapore-startup-investor-visa')); ?>">
                    <button class="service-p-btn">Know More</button>
                    </a>
            ...
            <div class="prt-service-single-content-area " style="padding:0px 40px 80px 40px;">
                                    ...
                                    <div class="bg-base-grey">
                                        <div class="featured-icon-box style13">
                                            ...
                                            <div class="featured-content">
    <div class="featured-title">
        <h3>Start Your Global Business & Secure Your Investor or Startup Visa</h3>
    </div>
    <div class="featured-desc">
        <p>Get expert support to launch your business and navigate Investor & Startup Visa programs in UAE, USA, UK, Canada, and Singapore.  
        We guide you every step of the way to make your global expansion seamless and successful.</p>
    </div>
   ...
   <section class="prt-row service02-about-section">
                        ...
                        <div class="col-lg-6 align-self-center ">
                            <div class="bg-base-grey text-center text-lg-start res-991-pt-20">
                                ...
                                <div class="spacing-18">
                                    <h3 class="fs-20 mb-0">One Stop Solution for <strong class="text-base-skin"> All Your Startup & Investor Visa </strong> Needs</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 align-self-center">
    ...
    <div class="title-header">
        <h3>Investor & Startup Visa Services</h3>
        <h2 class="title">Helping <span>Entrepreneurs & Investors</span> Expand Globally</h2>
    </div>
    <div class="title-desc">
        <p>At <b>Your Company Name</b>, we provide expert guidance and end-to-end support for Indian business owners and startups seeking to establish their presence in UAE, USA, UK, Canada, and Singapore through Investor and Startup Visa programs.</p>
        
        <p>Whether you’re aiming to secure long-term residency or launch your business abroad, we simplify the complex visa process and help you navigate legal, financial, and business setup requirements with confidence.</p>
    </div>
</div>
<!-- section title end -->            
                            </div>
        ...
        <div class="wptb-heading">
            <div class="wptb-item--inner text-center mb-5">
                ...
                <h1 class="wptb-item--title">
                    <span>Expert Guidance & Seamless Business Setup Across Global Markets</span>
                </h1>
            </div>
        </div>
                    ...
                    <div class="wptb-item--inner">
                        <div class="wptb-heading">
                            <div class="wptb-item--inner text-center">
                                <h6 class="wptb-item--subtitle">GLOBAL BUSINESS & VISA EXPERTISE</h6>
                                <h1 class="wptb-item--title" style="font-family: 'fontello';">
                                    <span>Trusted Partner for Your International Expansion</span>
                                </h1>
                            </div>
                        </div>
                        ...
                        <div class="wptb--rating-label">Driving Business Growth & Visa Success</div>
                ...
                <div class="wptb-why-choose--inner">
                    <div class="row g-0">
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    ...
                                    <p class="wptb-item--description mb-0">Customized business setup and visa solutions designed to match your unique goals and circumstances.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Fast & Efficient Process</h3>
                                    <p class="wptb-item--description mb-0">Streamlined application and documentation handling to ensure quick approvals and hassle-free experience.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Affordable Packages</h3>
                                    <p class="wptb-item--description mb-0">Competitive pricing with transparent fees and no hidden costs for all business setup and visa services.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Comprehensive Support</h3>
                                    <p class="wptb-item--description mb-0">From company formation to visa processing and post-approval assistance, we cover all your needs under one roof.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 icon-box-col">
                            <div class="wptb-item--inner">
                                <div class="wptb-item--holder">
                                    <h3 class="wptb-item--title" style="font-family: 'fontello';">Global Market Expertise</h3>
                                    <p class="wptb-item--description mb-0">In-depth knowledge of UAE, USA, UK, Canada, and Singapore business and immigration laws to ensure compliance and success.</p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-12 p-0">
                <div class="prt-processbox-wrapper" style="display: flex; justify-content: space-between;">
                    <div class="prt-processbox processbox-03" style="width: 57%; height: auto; overflow: scroll;">
                        <div class="">
                            <h2 class="title m-0" style="font-size: 26px;">Some of our <span>Business Highlights &</span> Features</h2>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Global Business Setup Expertise</h3>
                                </div>
                                <div class="prt-box-description">
                                    We assist you in seamlessly establishing your business in UAE, USA, UK, Canada, and Singapore, ensuring full compliance with local laws and regulations.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Investor & Startup Visa Application Support</h3>
                                </div>
                                <div class="prt-box-description">
                                    Comprehensive guidance and end-to-end support for investor and startup visa applications to increase your chances of approval.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Compliance & Legal Documentation</h3>
                                </div>
                                <div class="prt-box-description">
                                    We handle all necessary documentation, licensing, and compliance formalities, so you avoid delays and legal issues.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Personalized Business & Immigration Consultation</h3>
                                </div>
                                <div class="prt-box-description">
                                    Our experts provide tailored consultations based on your business goals and immigration needs to craft the best strategy for success.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                <div class="featured-title">
                                    <h3>Post-Visa Business Support & Growth</h3>
                                </div>
                                <div class="prt-box-description">
                                    Beyond visa approval, we assist with business operations, market entry, and ongoing compliance to help you thrive globally.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="processbox-content">
                            ...
                            <div class="processbox-info">
                                ...
                                <div class="prt-box-description">
                                    High-quality services tailored to your budget with no hidden fees — ensuring value every step of the way.
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/startups-investor-visa.blade.php ENDPATH**/ ?>