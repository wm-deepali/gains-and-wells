...
<!--</div>-->
                        ...
                        <div class="top_bar_contact_item top_bar_social ms-auto"
                         ...
                         <!--   <a href="#" class=""
                            ...
                            <a href="<?php echo e(route('blogs')); ?>" class="top-header-btn">
                       ...
                       <i class="fa-solid fa-mobile"></i> &nbsp; News</a>
                        ...
                        <div class="top-header-line"></div>
                            ...
                            <i class="fa-solid fa-mobile"></i> &nbsp; Blogs</p></a>
                             <div class="top-header-line"></div>
                              ...
                              <div class="top-header-line"></div>
                               ...
                               <!--<a href="<?php echo e(route('corp-legal-compliances')); ?>" class="top-header-btn" >-->
                               ...
                               <!--<a href="<?php echo e(route('virtual-cfo-services')); ?>" class="top-header-btn" >-->
                               <!--    <i class="fa-solid fa-mobile"></i> &nbsp; Virtual CFO Services</p></a>-->
                                   <div class="top-header-line"></div>
                               
                               <a href="<?php echo e(route('hrms')); ?>" class="top-header-btn" >
                            ...
                            <!--<a href="<?php echo e(route('company-setup-offer')); ?>" class=""-->
                            <!--    style="margin: auto;margin-left: 0px; margin-right: 0px;">-->
                            <!--    <button class="cost-calculate-btn">-->
    ...
    margin-bottom: 10px;">
                                <h1>
                                    <a class="home-link" href="<?php echo e(route('home')); ?>" title="Truvik" rel="home ">
<img id="logo-img" height="40" width="160" class="img-fluid auto_size"
    src="<?php echo e(asset('assets/img/indcorp.png')); ?>"
    alt="logo-img">
                            ...
                            <!--<a href="<?php echo e(route('msme-attention')); ?>" class=""-->
                            <!--    style="margin: auto;margin-left: 0px; margin-right: 0px;">-->
                            ...
                            <nav class="main-menu menu-mobile" id="menu" style="width:100%;">
                                <ul class="menu">
                                    ...
                                    <ul class="mega-submenu">
                                        ...
                                        <!--<li><a href="<?php echo e(route('our-experts')); ?>">Our Experts</a></li>-->
                                        <li><a href="#">Our Experts</a></li>
                                         <li><a href="<?php echo e(route('why-indcorp')); ?>">Why IndCorp</a></li>
                                          <!--<li><a href="<?php echo e(route('awards-certifications')); ?>">Awards & Certifications</a></li>-->
                                            <li><a href="#">Awards & Certifications</a></li>
                                           <!--<li><a href="<?php echo e(route('press-media')); ?>">Press & Media</a></li>-->
    ...
    <li><a href="<?php echo e(route('accounts-and-book-keeping')); ?>">Accounting & Bookkeeping Services</a></li>
    <li><a href="<?php echo e(route('auditing')); ?>">Financial Reporting & Audit Services</a></li>
    <li><a href="<?php echo e(route('financial-advisory-service')); ?>">Business & Financial Advisory Services</a></li>
    <li><a href="<?php echo e(route('compliances')); ?>">GST, VAT & TDS Compliance Services</a></li>
    <li><a href="<?php echo e(route('hrms')); ?>">HR & Payroll Management Solutions</a></li>
    <li><a href="<?php echo e(route('taxation')); ?>">Tax Computation & Filing Services</a></li>
    <li><a href="<?php echo e(route('commercial-license-services')); ?>">Business, Commercial & Trade Licensing Services</a></li>
    
    <li><a href="<?php echo e(route('bank-account-assistance')); ?>">Bank Account Assistance</a></li>
    <li><a href="<?php echo e(route('trademark-and-copyrights')); ?>">Trademark & Copyright</a></li>
</ul></li>
...
<li class="mega-menu-item active">
 <a href="#" class="mega-menu-link">Cross-Border Business Advisory & Support <i class="fa-solid fa-caret-down"></i></a>
   ...
   <!-- <li><a href="<?php echo e(route('business-setup-usa')); ?>">USA</a></li>
  <li class="active"><ahref="<?php echo e(route('business-setup-uk')); ?>">United Kingdoom (UK)</a> </li>
<li><a href="<?php echo e(route('business-setup-dubai-uae')); ?>">UAE & Dubai </a></li>
  <li><a href="<?php echo e(route('business-setup-canada')); ?>">Canada</a></li>
   <li class="mega-menu-item">
<li><a href="<?php echo e(route('business-setup-singapore')); ?>">Singapore</a></li> -->
</li>
</ul> </li>

   <li><a href="<?php echo e(route('accounts-and-book-keeping')); ?>">Accounting & Book-keeping Services</a></li>
 <li><a href="<?php echo e(route('financial-advisory-service')); ?>">Business & Financial Advisory</a></li>
                               <!-- <li class="mega-menu-item">
                                    <a href="<?php echo e(route('financial-advisory-service')); ?>">Business & Financial Advisory </a>
                                </li>
                              <li class="mega-menu-item">
                                    <a href="<?php echo e(route('startups-investor-visa')); ?>">Startup & Investor Visa</a>
                                </li> -->
                           ...
                           <!--     <li class="mega-menu-item">
                                    ...
                                    <ul class="mega-submenu">
                                      <!--  <li><a href="#">Corporate Funding</a></li> 
                                        <li><a href="<?php echo e(route('commercial-license-services')); ?>">Commercial & Trade License</a></li>
                                        
                                        <li><a href="<?php echo e(route('permanent-residency-visa')); ?>">Permanent Residency Visa</a></li>
 ...
 <a href="#" class="mega-menu-link">Taxation <i class="fa-solid fa-caret-down"></i></a>
        <ul class="mega-submenu">
        <!--<li><a href="<?php echo e(route('income-tax-filling')); ?>">Income Tax</a></li>-->
          <li><a href="#">Income Tax</a></li>
         <!--<li><a href="<?php echo e(route('gst-returns')); ?>">GST</a></li>-->
         <li><a href="#">GST</a></li>
 ...
 <li class="mega-menu-item">
 <!-- <a href="<?php echo e(route('contact-us')); ?>">Contact us<i class="fa-solid fa-caret-down"></i></a>-->
 <!-- <ul class="mega-submenu">-->
 <!--<li><a href="<?php echo e(route('corp-legal-compliances')); ?>">Corp Legal & Compliances</a></li>-->
 <!-- <li><a href="#">Corp Legal & Compliances</a></li>-->
 <!-- <li><a href="<?php echo e(route('virtual-cfo-services')); ?>">Virtual CFO Services</a></li>-->
 <!--   <li><a href="#">Virtual CFO Services</a></li>-->
 <!--  <li><a href="<?php echo e(route('hrms')); ?>">HRMS</a></li>-->
 <!-- <li><a href="<?php echo e(route('contact-us')); ?>">Contact us</a></li>-->
 <!--                                       <li><a href="<?php echo e(route('share-your-feedback')); ?>">Share Your Feedback</a></li>-->
 <!--                                       <li><a href="<?php echo e(route('become-a-channel-partner')); ?>">Become Channel Partner</a></li>-->
 <!--                                       <li><a href="<?php echo e(route('career-with-us')); ?>">Career with Us</a></li> -->
 <!--                                   </ul>-->
 <!--                               </li>-->
...
<div class="left-social-icon">
    ...
    <?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/layouts/includes/header.blade.php ENDPATH**/ ?>