<div class="col-md-5 offset-md-1">
    <div class="wptb-appointment-form-one">
        <div class="wptb-form--wrapper">
           <form class="wptb-form" id="bookfrm" method="POST" action="<?php echo e(route('submit.package')); ?>">
    <?php echo csrf_field(); ?>
 ...
 <?php $pageData = App\Helpers\Helper::getCurrentPage(); ?>
                        ...
                        <div class="col-md-12 col-lg-12 mb-4" style="display:flex;">
                            <div class="form-group"  style="width:48%;">
                             <?php $phonecodes = App\Helpers\Helper::getCountryPhoneCode(); ?>
                              <select id="faq_country_code" name="country_code" class="codecountry" required>
   ...
   <div class="col-md-12 col-lg-12 mb-4">
    ...
    <!-- submit -->
    <button type="submit" class="bookappbutton">Make Appointment</button>
</form>
            ...
            <div class="wptb-form--bottom">
                <div class="wptb-heading">
                    <div class="wptb-item--inner">
                        ...
                        <h1 class="wptb-item--title"> <span>+91-9220899544 </span></h1>
...
$.ajaxSetup({
    ...
    $(document).on('change', '#service_id', function(event) {
        ...
        $.ajax({
            url: `<?php echo e(URL::to('fetch-subservice/${service_id}')); ?>`,
            type: 'GET',
            dataType: 'json',
...
event.preventDefault()
            ...
            $.ajax({
                url: `<?php echo e(URL::to('book-appointments')); ?>`,
                type: 'POST',
                processData: false,
                contentType: false,
                dataType: 'json',
...
<?php $__env->stopPush(); ?><?php /**PATH /home/ashtonwell/public_html/resources/views/front/layouts/includes/form.blade.php ENDPATH**/ ?>