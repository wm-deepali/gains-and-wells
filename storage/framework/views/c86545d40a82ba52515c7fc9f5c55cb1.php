            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12">
                        ...
                        <textarea class="form-control" name="short_description" id="short_description" cols="30" rows="2" maxlength="170"></textarea>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="date" class="form-control" placeholder="Enter Publish Date" name="publish_date" id="publish_date">
...
</script><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/admin/blogs/ajax/create.blade.php ENDPATH**/ ?>