...
<div class="mobile-top-index-banner-freezone" style=" background-image: url('<?php echo e(asset('assets/images/maydon-mobile.png')); ?>');">
...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Meydan Free Zone <span>Business</span> Setup</h1>

                                   <p style="color: #fff;"> Launch your business in Meydan Free Zone — an elegant business district<br> with a prestigious address in Dubai.</p>
                <div class="position-relative mb-15">
                    ...
                    <ul class="prt-list style2" style="color: #fff;">
                        <li style="color: #fff;">
                            ...
                            <span class="" style="color: #fff;margin-left:10px;"> Perfect for startups and SMEs with easy setup</span>
                        </li>
                        <li style="color: #fff;">
                            <i class="fa fa-check" aria-hidden="true" style="color: #fff;"></i>
                            <span class="" style="color: #fff; margin-left:10px;">Digital business environment.</span>
                        </li>
...
<!-- page-title -->
        <div class="top-banner-bank-freezone-maydon">
            <div class="top-banner-title">
                <h1 style="font-size: 44px; font-weight: 600;"><span style="color: rgb(0, 60, 255);">Meydan Free Zone </span><br /> <span style="color: rgb(255, 123, 0);"> Business </span><span
                        style="color: rgb(0, 60, 255);"> Setup</span></h1>
                        <p style="color: #000;"> Launch your business in Meydan Free Zone — an elegant business district<br> with a prestigious address in Dubai.</p>
                <div class="position-relative mb-15">

                    <ul class="prt-list style2" style="color: #fff;">
                        <li style="color: #000;">
                            <i class="fa fa-check" aria-hidden="true" style="color: #000;"></i>
                            <span class="" style="color: #000;margin-left:10px;"> Perfect for startups and SMEs with easy setup</span>
                        </li>
                        <li style="color: #000;">
                            <i class="fa fa-check" aria-hidden="true" style="color: #000;"></i>
                            <span class="" style="color: #000; margin-left:10px;">Digital business environment.</span>
                        </li>
                ...
                <!-- <h1 style="font-size: 20px; color: rgb(0, 60, 255); margin-top: 50px;">Starting From AED <span
                        style="font-size: 44px; font-weight: 600;">6,875</span> </h1>
                <div class="d-flex gap-2 ">
                    <button class="banner-btn">How it work?</button>
                    <button class="banner-btn">Why Choose Us?</button>
                    <button class="banner-btn">Pricing</button>
                    <button class="banner-btn">Bank Accounts </button>
                    <button class="banner-btn">Process</button>
                </div>

                <h1 style="font-size: 20px; color: rgb(0, 60, 255); margin-top: 50px;">Trusted by over 4,000 Clients
                </h1> -->
            </div>
                            ...
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Company Setup
                                            in Meydan Free Zone</h3>
                                        <h2 class="title">How To Setup A <span>Company in</span> Meydan Free Zone, UAE?</h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>Meydan Free Zone offers an exceptional location for entrepreneurs seeking a premium business setup experience in the heart of Dubai. With over 1,500 business activities, 100% foreign ownership, and a fully digital setup process, Meydan combines convenience with prestige. It’s ideal for consultants, freelancers, and tech-driven businesses looking for a smart and strategic location to grow.</p>
                                    </div>
                                        ...
                                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                                            ...
                                            <div class="featured-content">
                                                ...
                                                <div class="featured-desc">
                                                    <p>Enjoy full foreign ownership of your company with no local sponsor required.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                                            ...
                                            <div class="featured-content">
                                                ...
                                                <div class="featured-desc">
                                                    <p>Benefit from zero corporate and personal tax in UAE Free Zones.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="prt-processbox-wrapper">
                                ...
                                <div class="prt-processbox processbox-02">
                                    <div class="prt-box-image">
                                        ...
                                        <img class="img-fluid" src="<?php echo e(asset('assets/images/process-box/01.png')); ?>" alt="step-one">
                                        </div>
                                    </div>
                                ...
                                <div class="prt-processbox processbox-04">
                                    <div class="prt-box-image">
                                        <div class="prt-process-image">
                                        <img class="img-fluid" src="<?php echo e(asset('assets/images/process-box/03.png')); ?>" alt="step-three">
                                        </div>
                                    </div>
                                    <div class="processbox-content">
                                        <div class="prt-number-box">
                                        ...
                                        <div class="layer-content">
                                            <div class="featured-icon-box style4">
                                                ...
                                                <div class="featured-content">
                                                    ...
                                                    <div class="featured-desc">
                                                        <p>Contact us today by filling out the enquiry form, and our experts will guide you through every step of your business setup journey.</p>
                                                    </div>
                                                    <div class="mr-30 mb-25 mt-3 res-991-mr-0 res-991-mb-0">
                                                          <a class="prt-btn prt-btn-size-sm  prt-btn-style-fill prt-btn-color-skincolor" data-bs-toggle="offcanvas" href="#offcanvasExample"
                                                            >Get a Callback</a>
                                                    </div>
                                                </div>
                                            </div>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/meydan-feezone.blade.php ENDPATH**/ ?>