...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Financial Advisory Services <span> to Drive </span> Strategic Growth & Innovation </h1>
<button class="cost-calculate-banner animated-button" data-bs-toggle="offcanvas" href="#offcanvasExample">
    ...
    <div class="top-banner-bank-it p-15">
            <div class="top-banner-title" style=" width:61%;">
                <h1 style="color: #000;"><span>Financial Advisory Services  <span style="color: #f36f27;"></span> to Drive<span
                            style="color: #b12e5f;"> Strategic Growth & Innovation  </span> </span> </h1>
                <p style="color: #000; font-size:18px;font-weight:400;">Our Financial advisory services are tailored to help businesses navigate challenges, seize new opportunities, and make smarter decisions. With deep industry knowledge and a future-focused approach, we guide you through strategy, operations, financial planning, and transformation initiatives that unlock real business value.
                </p>
  ...
  <img src="<?php echo e(asset('assets/images/expert.png')); ?>" class="main-image" alt="Website Image" width="220px">
 ...
 <!--       </div>-->
                        ...
                        <div class="col-lg-6 align-self-center ">
                            <div class="bg-base-grey text-center text-lg-start res-991-pt-20">
                                ...
                                <div class="spacing-18">
                                    <h3 class="fs-20 mb-0">One Stop Solution for <strong class="text-base-skin"> Advisory Services In</strong> India & Abroad!</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 align-self-center">
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        ...
                                        <h2 class="title">Leanr more, how we help <span>Businesses & Startups</span></h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>At <b>IndCorp Advisory Services</b> Every business faces unique challenges—from market disruptions and digital transformation to operational inefficiencies and compliance hurdles. Our advisory solutions are crafted to provide strategic insight, practical solutions, and measurable impact.</p>
                                        
                                        <p>Our consultants bring in-depth experience and a problem-solving mindset, ensuring we deliver not just advice—but results</p>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                                            ...
                                            <div class="featured-content">
                                                ...
                                                <div class="featured-desc">
                                                    <p>Complete solutions for Advisory Services under one roof.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="title-page col-10 border-bottom pb-3 mb-15">
        <h2>Advisory <br>That Goes Beyond Consultation</h2>
        <p class="text-center" style="color: #abafb5;">Our advisory services are designed to empower your decision-making with clarity, confidence, and a competitive edge. Whether you're scaling up, diversifying, or transforming, we act as your thinking partner every step of the way.</p>
    </div>
    <div class="row col-10">
        <div class="col-md-6 res-767-mb-30">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">Strategic Business Planning
                        </h3>
                    </div>
                    <div class="featured-desc">
                        <p> We work closely with leadership to define, refine, and implement business strategies aligned with your vision and market dynamics..</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">Financial & Operational Guidance</h3>
                    </div>
                    <div class="featured-desc">
                        <p >From budgeting and forecasting to performance reviews, we help strengthen financial health and operational agility.</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="prt-processbox processbox-03" style="width: 57%; height: auto; overflow: scroll;">
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            ...
                                            <div class="prt-box-description"> We don’t believe in one-size-fits-all. Our strategies are aligned with your unique goals and market realities.</div>
                                        </div>
                                    </div>
                                    <div class="processbox-content">
                                        <div class="prt-number-box">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Expert Industry Insight
                                                </h3>
                                            </div>
                                            <div class="prt-box-description"> Gain the advantage of our cross-sector expertise to make informed decisions with confidence..</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>End-to-End Strategic Support
                                                </h3>
                                            </div>
                                            <div class="prt-box-description">From planning to execution, we stay involved to ensure every strategy is actionable and effective..</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Growth & Transformation Focus</h3>
                                            </div>
                                            <div class="prt-box-description">We specialize in guiding businesses through scale-up stages, digital adoption, and operational change.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            ...
                                            <div class="prt-box-description"> Leverage analytics, benchmarking, and financial modeling for more accurate decision-making.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Risk Identification & Mitigation
                                                </h3>
                                            </div>
                                            <div class="prt-box-description">Spot potential pitfalls early and build resilient systems to navigate them successfully.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>M & A and Investment Advisory</h3>
                                            </div>
                                            <div class="prt-box-description"> Get expert support for due diligence, valuation, deal structuring, and integration planning.</div>
                                        </div>
                                    </div>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/financial-advisory-service.blade.php ENDPATH**/ ?>