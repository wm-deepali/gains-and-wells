							...
							<div class="in-stretch">
								<article class="uk-card uk-card-default uk-border-rounded">
									<div class="uk-card-media-top">
										<img src="<?php echo e(asset('front_assets')); ?>/img/user/image-featured-a4DfvV.html" alt="The typical U.S. household is spending $445 more a month due to inflation">
									</div>
									<div class="uk-card-body">
										...
										<div class="uk-flex">
											<div class="uk-margin-small-right">
												<img class="uk-border-pill uk-background-muted" src="<?php echo e(asset('front_assets')); ?>/img/user/author-85z9UC.html" alt="image-team" width="32" height="32">
											</div>
