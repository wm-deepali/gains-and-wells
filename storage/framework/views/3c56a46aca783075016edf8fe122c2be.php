...
<tbody> <?php $i=1; ?>
   ...
   <td> <?php echo e($business->page->title ?? 'NA'); ?>  </td>
     ...
     <td><?php echo e($business->service->service ?? 'NA'); ?></td>
     
         <td><?php echo e($business->full_name); ?> </br><?php echo e($business->email); ?> </br> <?php echo e($business->mobile); ?>

</td>
<td><?php echo e($business->location); ?></td>
<td>

<?php if(strlen($business->details) > 50): ?>
            <?php echo e(substr($business->details,0,50)); ?>

            <span class="read-more-show hide_content">More<i class="fa fa-angle-down"></i></span>
            <span class="read-more-content"> <?php echo e(substr($business->details,50,strlen($business->details))); ?> 
    ...
    function deleteConfirmation(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `<?php echo e(URL::to('admin/manage-servicers/${id}')); ?>`,
                    type: "DELETE",
                    dataType: "json",
...
</script><?php /**PATH /home/ashtonwell/public_html/resources/views/admin/servicers/index.blade.php ENDPATH**/ ?>