...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Financial Reporting &  Auditing Services 

<span> to Ensure </span> Financial Accuracy & Compliance </h1>
    ...
    <div class="top-banner-bank-it p-15">
            <div class="top-banner-title" style=" width:61%;">
                <h1 style="color: #000;"><span>Financial Reporting & Auditing  <span style="color: #b12e5f;"> Services to Ensure Financial </span> <span style="color: #000;">  Accuracy & Compliance </span> </span> </h1>
                <p style="color: #003760; font-size:18px;">Our Financial Reporting & Auditing services provide clear, objective insights into your company’s financial standing. With a focus on transparency and regulatory compliance, we help businesses identify risks, uncover inefficiencies, and build trust with investors, partners, and authorities.
                </p>
  ...
  <img src="<?php echo e(asset('assets/images/audit.png')); ?>" class="main-image" alt="Website Image" width="220px">
 ...
 <!--       </div>-->
                        ...
                        <div class="col-lg-6 align-self-center ">
                            <div class="bg-base-grey text-center text-lg-start res-991-pt-20">
                                <div class="prt_single_image-wrapper res-991-ml-20 res-991-mr-20">
                                    <img class="img-fluid" src="<?php echo e(asset('assets/images/audit-service.png')); ?>" alt="single-img-9">
                                </div>
                                <div class="spacing-18">
                                    <h3 class="fs-20 mb-0">Get your business<strong class="text-base-skin"> audit done by experienced</strong> Team!</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 align-self-center">
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Company Audits
                                            Service</h3>
                                        <h2 class="title">Learn more about<span>our Auditing services</span></h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>At <b>IndCorp Advisory Services - </b> auditing solutions are designed to help businesses stay compliant, gain financial clarity, and drive operational improvements. Whether you're a startup, SME, or an established enterprise, we tailor our approach to meet your industry and regulatory requirements.</p>
                                        <p>Our auditors follow strict ethical practices and use modern tools to deliver accurate, timely, and insightful audit reports that add real value to your business.</p>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                                            ...
                                            <div class="featured-content">
                                                ...
                                                <div class="featured-desc">
                                                    <p>Complete solutions for Company Audits under one roof.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="title-page col-10 border-bottom pb-3 mb-15">
        <h2>Why Our <br>Why Our Auditing Services Stand Out

</h2>
        <p class="text-center" style="color: #abafb5;">Auditing is not just about ticking checkboxes—it's about uncovering insights, ensuring accountability, and improving your business foundation. Our auditing solutions go beyond numbers to give you confidence and clarity.</p>
    </div>
    <div class="row col-10">
        <div class="col-md-6 res-767-mb-30">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">Risk Mitigation & Compliance
                        </h3>
                    </div>
                    <div class="featured-desc">
                        <p> We help you identify financial and operational risks, ensuring your business stays aligned with all regulatory standards and statutory obligations.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">Independent Financial Assessment</h3>
                    </div>
                    <div class="featured-desc">
                        <p >Our unbiased audit reports provide a transparent overview of your company’s financial activities—ideal for stakeholders, lenders, and investors.</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="prt-processbox processbox-03" style="width: 57%; height: auto; overflow: scroll;">
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Experienced Audit Professionals</h3>
                                            </div>
                                            <div class="prt-box-description"> A team of qualified auditors with experience across diverse industries and business sizes.</div>
                                        </div>
                                    </div>
                                    <div class="processbox-content">
                                        <div class="prt-number-box">
                                        ...
                                        <div class="processbox-info">
                                            ...
                                            <div class="prt-box-description"> Ensures your business adheres to government regulations, tax laws, and financial standards.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            ...
                                            <div class="prt-box-description">Detailed and easy-to-understand audit reports that support informed decision-making</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Technology-Driven Audits</h3>
                                            </div>
                                            <div class="prt-box-description">We use advanced auditing tools and automation to enhance accuracy and reduce manual errors.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Customized Audit Plans</h3>
                                            </div>
                                            <div class="prt-box-description"> Audit strategies tailored to your industry, risk profile, and business objectives.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Internal Control Evaluation
                                                </h3>
                                            </div>
                                            <div class="prt-box-description">Identify weaknesses in your control systems and get actionable recommendations for improvement.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            ...
                                            <div class="prt-box-description"> Structured audit processes ensure we deliver on time—without compromising depth or detail.</div>
                                        </div>
                                    </div>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/auditing.blade.php ENDPATH**/ ?>