...
<head>
    ...
    <title>Ashton & Well Admin Dashboard</title>
    <!--  <title>Krishna Chikan | <?php echo $__env->yieldContent('title'); ?></title> -->
  
    <link rel="icon" href="<?php echo e(asset('assets/images/overseaslogo.png')); ?>"/>
    <!-- BEGIN VENDOR CSS-->
...
</script><?php /**PATH /home/ashtonwell/public_html/resources/views/admin/top-header.blade.php ENDPATH**/ ?>