                                ...
                                <div class="in-timeline-branch">
                                    <div class="uk-flex">
                                        ...
                                        <div class="in-timeline-title uk-flex uk-flex-middle">
                                            ...
                                            <span class="uk-label in-label-small">on progress</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="uk-box-shadow-small uk-width-expand">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tpmhelpinghand/public_html/gains-and-well.tpmhelpinghand.com/resources/views/front/roadmap.blade.php ENDPATH**/ ?>