...
?>      
  ...
  <meta name="keywords" content="<?php echo $seodata->meta_keyword ??  'Overseas'; ?>">
    ...
    =======================================-->
     ...
     <?php echo $__env->yieldPushContent('require-script'); ?>
</head>
<body>
    
    <?php echo $__env->yieldPushContent('require-body-script'); ?>
    <!-- page start -->
    <div class="page">
   
        <?php echo $__env->make('front.layouts.includes.header2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/layouts/layout.blade.php ENDPATH**/ ?>