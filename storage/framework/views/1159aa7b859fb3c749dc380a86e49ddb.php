...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">End-to-End <span> Compliances</span> Solutions for Hassle-Free Business Operations Stunning Websites </h1>
<button class="cost-calculate-banner animated-button" data-bs-toggle="offcanvas" href="#offcanvasExample">
    ...
    <div class="top-banner-bank-it p-15">
            <div class="top-banner-title" style=" width:61%;">
                <h1 style="color: #000;"><span>End-to-End Compliances <span style="color: #b12e5f;">Solutions</span> <span
                            style="color: #000;">  for <span style="color: #b12e5f;">Hassle-Free</span> Business Operations </span> </span> </h1>
                <p style="color: #003760;">Stay on top of statutory, financial, and regulatory requirements with our expert compliance services. We ensure your business meets all obligations—accurately, on time, and with zero stress—so you can focus on what matters: growth and performance.
  ...
  <img src="<?php echo e(asset('assets/images/complience.png')); ?>" class="main-image" alt="Website Image" width="220px">
 ...
 <!--       </div>-->
                        ...
                        <div class="col-lg-6 align-self-center ">
                            <div class="bg-base-grey text-center text-lg-start res-991-pt-20">
                                <div class="prt_single_image-wrapper res-991-ml-20 res-991-mr-20">
                                    <img class="img-fluid" src="<?php echo e(asset('assets/images/complience-img.png')); ?>" alt="single-img-9">
                                </div>
                                <div class="spacing-18">
                                    <h3 class="fs-20 mb-0">One Stop Solution for <strong class="text-base-skin"> Compliances In India </strong> & Abroad!</h3>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 align-self-center">
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Compliances Solution</h3>
                                        <h2 class="title">What you Need, <span>We do!</span></h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>At <b>IndCorp Advisory Services</b> With rapidly changing regulations and increased scrutiny, compliance is no longer optional—it’s critical. Our comprehensive compliance services cover every aspect of business obligations, helping you avoid penalties, maintain transparency, and build stakeholder trust.</p> </br>
                                        <p>Whether you’re a startup, MSME, or a large enterprise, our team ensures that your business stays compliant and audit-ready at all times.</p>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                                            ...
                                            <div class="featured-content">
                                                ...
                                                <div class="featured-desc">
                                                    <p>Complete solutions for Compliances in Domestic & International.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div class="title-page col-10 border-bottom pb-3 mb-15">
        <h2>Compliances <br>That Keep You Protected and Prepared</h2>
        <p class="text-center" style="color: #abafb5;">Avoid unnecessary fines, delays, and legal complexities. With our streamlined compliance services, you get accuracy, timeliness, and complete peace of mind.</p>
    </div>
    <div class="row col-10">
        <div class="col-md-6 res-767-mb-30">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">Corporate & Tax Compliances
                        </h3>
                    </div>
                    <div class="featured-desc">
                        <p> Ensure your GST, TDS, and income tax filings are always up-to-date and 100% compliant.</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="featured-icon-box icon-align-before-content icon-ver_align-top style7">
                ...
                <div class="featured-content">
                    <div class="featured-title">
                        <h3 style="color: #fff;">ROC & MCA Filing Services</h3>
                    </div>
                    <div class="featured-desc">
                        <p >We handle company filings, resolutions, and statutory disclosures with absolute accuracy and punctuality..</p>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="prt-processbox processbox-03" style="width: 57%; height: auto; overflow: scroll;">
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            ...
                                            <div class="prt-box-description"> From financial compliance to secretarial, we cover it all under one roof.</div>
                                        </div>
                                    </div>
                                    <div class="processbox-content">
                                        <div class="prt-number-box">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Timely Reminders & Filing
                                                </h3>
                                            </div>
                                            <div class="prt-box-description"> Never miss a deadline—we track, remind, and file everything on schedule.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Dedicated Compliance Experts
                                                </h3>
                                            </div>
                                            <div class="prt-box-description">Work with professionals who understand evolving laws and their practical application.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Customized Compliance Plans</h3>
                                            </div>
                                            <div class="prt-box-description">Get a solution tailored to your industry, entity type, and operational model.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>End-to-End Documentation Support</h3>
                                            </div>
                                            <div class="prt-box-description"> We prepare and manage resolutions, reports, registers, and filing documentation for you.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Government Liaisoning
                                                </h3>
                                            </div>
                                            <div class="prt-box-description">We coordinate with authorities like GST, Income Tax, MCA, RBI, and Labour departments on your behalf.</div>
                                    ...
                                    <div class="processbox-content">
                                        ...
                                        <div class="processbox-info">
                                            <div class="featured-title">
                                                <h3>Risk-Free Audit Preparedness</h3>
                                            </div>
                                            <div class="prt-box-description"> Be always ready for inspections or audits with clean, well-maintained records and reports.</div>
                                        </div>
                                    </div>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/compliances.blade.php ENDPATH**/ ?>