...
<li class="breadcrumb-item active">Business Activities
</li>
</ol>
</div>
...
<script>
    function deleteConfirmation(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: `<?php echo e(URL::to('admin/manage-business/${id}')); ?>`,
                    type: "DELETE",
                    dataType: "json",
    ...
    $(document).ready(function() {
        ...
        $(document).on("click", ".add-state", function(event) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('admin/manage-business/create')); ?>",
                type: "GET",
                dataType: "json",
                success: function(result) {
                    if (result.success) {
        ...
        $(document).on("click", ".edit-state", function(event) {
            ...
            $.ajax({
                url: `<?php echo e(URL::to('admin/manage-business/${id}/edit')); ?>`,
                type: "get",
                dataType: "json",
                success: function(result) {
                    if (result.success) {
...
<?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/admin/business/index.blade.php ENDPATH**/ ?>