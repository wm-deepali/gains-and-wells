...
<tr>
<td><?php echo e($getCategory->created_at); ?></td>
<td><?php echo e($getCategory->name); ?></td>
<td><?php echo e($getCategory->url); ?></td>
<!-- <td><?php echo e($getCategory->url); ?></td> -->

<td><?php echo e($getCategory->status); ?></td>
<td class="text-truncate">
<a href="javascript:void(0)" class="edit-category text-dark mr-2" category_id="<?php echo e($getCategory->id); ?>" title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i></a>
<a href="javascript:void(0)" onclick="deleteConfirmation(<?php echo e($getCategory->id); ?>)" title="Delete" class="text-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
...
$.ajax({
url: `<?php echo e(URL::to('admin/manage-blog-category/${id}')); ?>`,
type: "DELETE",
dataType: "json",
...
$.ajax({
url: "<?php echo e(URL::to('admin/manage-blog-category/create')); ?>",
type: "GET",
dataType: "json",
success: function(result) {
if (result.success) {
...
$.ajax({
url: "<?php echo e(URL::to('admin/manage-blog-category')); ?>",
type: 'POST',
processData: false,
contentType: false,
dataType: 'json',
...
$.ajax({
url: `<?php echo e(URL::to('admin/manage-blog-category/${id}/edit')); ?>`,
type: "get",
dataType: "json",
success: function(result) {
if (result.success) {
...
$.ajax({
url: `<?php echo e(URL::to('admin/manage-blog-category/${category_id}')); ?>`,
type: 'POST',
processData: false,
contentType: false,
dataType: 'json',
...
<?php /**PATH /home/tpmhelpinghand/public_html/gains-and-well.tpmhelpinghand.com/resources/views/admin/blog-categories/index.blade.php ENDPATH**/ ?>