...
@keyframes fadeIn {
  ...
  to { opacity: 1; transform: scale(1); }
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Streamlined  <span>Accounts & Book Keeping</span> Solutions for Business Growth</h1>
<button class="cost-calculate-banner animated-button" data-bs-toggle="offcanvas" href="#offcanvasExample">
    ...
    <div class="top-banner-bank-it p-15">
            <div class="top-banner-title" style=" width:61%;">
                <h1 style="color: #000;"><span>Streamlined  <span style="color: #b12e5f;"> </br> Accounts & Book Keeping </span> Solutions for Business Growth <span
                            style="color: #f36f27;">   </span> </span> </h1>
                <p style="color: #000; font-size:18px;">Simplify your accounts operations with expert accounting, bookkeeping, tax planning, and compliance services. We help you stay audit-ready and financially healthy—so you can focus on scaling your business.
                </p>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/accounts-and-book-keeping.blade.php ENDPATH**/ ?>