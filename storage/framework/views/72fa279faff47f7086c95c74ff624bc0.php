...
@media (max-width: 576px) {
  ...
  .icon-box-col:last-child {
    ...
    <div class="mobile-top-index-banner-freezone" style=" background-image: url('<?php echo e(asset('assets/images/google-addword.png')); ?>');">
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Drive Instant <span> Traffic & Results </span> with Targeted Paid Campaigns</h1>
           ...
           <div class="position-relative mb-15">
                    ...
                    <ul class="prt-list style2" style="color: rgb(0, 60, 255);">
                        <li style="color: rgb(0, 60, 255);">
                            ...
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);"> Maximum ROI</span>
                        </li>
                        <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);">100% Satisfactory Results</span>
                        </li>
        ...
        <div class="top-banner-bank-it p-15">
            <div class="top-banner-title" style=" width:61%;">
                <h1 style="color: #003760;"><span>Drive Instant Traffic & Results   <span
                            style="color: #f36f27;">with Targeted Paid Campaigns </span> </span> </h1>
                <p style="color: #003760;">Reach your ideal audience and boost conversions with our expertly managed Google Ads, Bing Ads, and PPC campaigns. We plan, create, and optimize every ad to ensure maximum ROI and business growth.
                </p>
                <div class="position-relative mb-15">
                            ...
                            <div class="pl-50 res-1199-pr-15 res-1199-pl-30 res-991-pl-15 res-991-mt-30">
                                ...
                                <div class="section-title mb-15">
                                    <div class="title-header">
                                        <!-- <h3>Why Choose Us</h3> -->
                                        <h2 class="title">Turn Clicks Into Customers with 

<span class="text-base-skin">
                                                Paid Ads That Work</span></h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>Paid advertising is one of the fastest ways to grow online — but only when done right. We help businesses like yours launch and manage effective PPC campaigns across Google, Bing, and social platforms. From keyword targeting to conversion optimization, we handle everything to make sure your ad spend delivers the results you expect.
                                        </p>
                                    </div>
                                ...
                                <div class="">
                                    ...
                                    <div class="prt-progress-bar" data-percent="95%">
                                        <div class="progressbar-title">Satisfactory Results Guaranteed</div>
                                        <div class="progress-bar-inner">
                                            <div class="progress-bar progress-bar-color-bar_skincolor">
...
<div class="row g-0">
  <div class="col-sm-6 icon-box-col">
    <div class="wptb-item--inner">
      <div class="wptb-item--holder">
        <h3 class="wptb-item--title" style="font-family: 'fontello';">Certified Google & Bing Ads Experts</h3>
        <p class="wptb-item--description mb-0">Our team is certified by Google and Bing, ensuring your campaigns follow best practices and deliver results.</p>
      </div>
    </div>
  </div>
  ...
  <div class="col-sm-6 icon-box-col">
    <div class="wptb-item--inner">
      <div class="wptb-item--holder">
        <h3 class="wptb-item--title" style="font-family: 'fontello';">Data-Driven Campaign Planning</h3>
        <p class="wptb-item--description mb-0">We use real-time data and insights to craft ad strategies that maximize reach and performance.</p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 icon-box-col">
    <div class="wptb-item--inner">
      <div class="wptb-item--holder">
        <h3 class="wptb-item--title" style="font-family: 'fontello';">ROI-Focused Strategy & Execution</h3>
        <p class="wptb-item--description mb-0">Every ad spend is optimized to bring measurable returns and drive business growth.</p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 icon-box-col">
    <div class="wptb-item--inner">
      <div class="wptb-item--holder">
        <h3 class="wptb-item--title" style="font-family: 'fontello';">Transparent Reporting & Communication</h3>
        <p class="wptb-item--description mb-0">Get clear, regular reports and honest updates—no guesswork, just real results.
...
.</p>
  ...
  <div class="col-sm-6 icon-box-col">
    <div class="wptb-item--inner">
      <div class="wptb-item--holder">
        <h3 class="wptb-item--title" style="font-family: 'fontello';">Experienced in Multiple Industries</h3>
        <p class="wptb-item--description mb-0">From e-commerce to real estate, we’ve run successful campaigns across diverse sectors.</p>
      </div>
    </div>
  </div>
  <div class="col-sm-6 icon-box-col">
    <div class="wptb-item--inner">
      <div class="wptb-item--holder">
        <h3 class="wptb-item--title" style="font-family: 'fontello';">Affordable Plans for All Budgets</h3>
        <p class="wptb-item--description mb-0">Whether you're a startup or scaling business, we offer plans that fit your goals and budget..</p>
      </div>
    </div>
  </div>
...
<!--                </div>-->
  ...
  <button>Talk To A Specialist</button>
    ...
    window.addEventListener('resize', updateSlider);
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ashtonwell/public_html/resources/views/front/adwords-ppc-campaigns.blade.php ENDPATH**/ ?>