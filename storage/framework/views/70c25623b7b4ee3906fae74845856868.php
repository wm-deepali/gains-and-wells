...
@media (max-width: 576px) {
  ...
  .icon-box-col:last-child {
    ...
    <div class="mobile-top-index-banner-freezone" style=" background-image: url('<?php echo e(asset('assets/images/erp1.png')); ?>');">
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Custom ERP & CRM Solutions <span> That Fit Your Business Perfectly </span></h1>
...
<a href="tel:++971 52 993 0830">
  <button>Talk To A Specialist</button>
    ...
    window.addEventListener('resize', updateSlider);
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ashtonwell/public_html/resources/views/front/erp-crms-custom-development.blade.php ENDPATH**/ ?>