                                        ...
                                        <div class="bg-base-grey spacing-25">
                                            ...
                                            <div class="section-title style7">
                                                <div class="title-header">
                                                    <h2 class="title" style="font-size: 26px;text-align: center;">Send Us Your Inquiry </h2>
                                                    <p style="text-align: center;">Please fill out the form to receive free consultation, from
                                                        one of our business setup advisors within 24 hours.</p>
                                                </div>
                                            </div><!-- section title end -->
                                                           <form method="POST" action="<?php echo e(route('submit.package')); ?>" class="contact_form clearfix" id="pkgfrm">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                    <!-- Full Name -->
                    <div class="col-md-12">                  
        ...
        <div class="mt-5">
            <button class="submit prt-btn prt-btn-size-md prt-btn-shape-round prt-btn-style-fill prt-btn-color-skincolor" type="submit">Submit Here</button> 
                                    ...
                                    </div><!--section-title-end --><?php /**PATH /home/overseasconsulta/public_html/indcorp/resources/views/front/layouts/includes/inquiry-frm.blade.php ENDPATH**/ ?>