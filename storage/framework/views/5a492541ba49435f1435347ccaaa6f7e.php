...
<div class="mobile-top-index-banner-freezone" style=" background-image: url('<?php echo e(asset('assets/images/azman-mobile.png')); ?>');">
    ...
    <div class="top-banner-title">
        <h1 class="animated-heading">Ajman Free Zone  <span> (AFZA) </span> Company Formation</h1>

             <div class="position-relative mb-15">

                    <ul class="prt-list style1 style-text" style="color: rgb(0, 60, 255);">
                        <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);">Enjoy quick licensing.</span>
                        </li>
                        <li style="color: rgb(0, 60, 255);">
                            <i class="fa fa-check" aria-hidden="true" style="color: rgb(0, 60, 255);"></i>
                            <span class="prt-list-li-content" style="color: rgb(0, 60, 255);">100% ownership, and seamless import-export options..</span>
                        </li>
...
<!-- page-title -->
        <div class="top-banner-bank-freezone-media">
            <div class="top-banner-title">
                <h1 style="font-size: 44px; font-weight: 600;"><span style="color: rgb(0, 60, 255);">Ajman Free Zone 
                        </span> <span style="color: rgb(255, 123, 0);"> (AFZA) </span><br /><span
                        style="color: rgb(0, 60, 255);"> Company Formation</span></h1>
                        <p style="color: rgb(128, 128, 128);">Start your business at Ajman Free Zone — a strategic and cost-effective free zone for all industries.</p>
                <div class="position-relative mb-15">
                ...
                <button class="cost-calculate-banner1" data-bs-toggle="offcanvas" href="#offcanvasExample">Get Started Today!</button>
                            ...
                            <div class="pl-15 res-1199-pl-0 res-991-mt-30">
                                ...
                                <div class="section-title">
                                    <div class="title-header">
                                        <h3>Company Setup
                                            in Ajman Free Zone</h3>
                                        <h2 class="title">How To Setup A <span>Company in</span> AFZA Free Zone, UAE?</h2>
                                    </div>
                                    <div class="title-desc">
                                        <p>Ajman Free Zone (AFZA) is one of the UAE’s oldest and most affordable free zones, offering a wide range of licenses for trading, services, and industrial sectors. It provides flexible business packages, easy access to Ajman Port, and a business-friendly environment for local and international investors. Its streamlined setup process and low-cost structure make it perfect for small to medium-sized businesses.</p>
                                    </div>
  ...
  document.querySelectorAll('.custom-modal').forEach(modal => {
    if (e.target === modal) {
      modal.style.display = 'none';
        ...
        <?php $__env->stopSection(); ?>
<?php echo $__env->make('front.layouts.app-common', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ashtonwell/public_html/resources/views/front/azman.blade.php ENDPATH**/ ?>